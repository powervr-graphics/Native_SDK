...
#
#   MVK_INCLUDE_DIR				MVK_DATATYPE_INCLUDE_DIR	MVK_DATATYPE_LIBRARIES	
#   MVK_DATATYPE_INCLUDE_DIR	MVK_MOLTEN_INCLUDE_DIR		MVK_MOLTEN_LIBRARIES	
...
if (APPLE AND NOT IOS)
	...
	set(MVK_INCLUDE_DIR ${MVK_DATATYPE_INCLUDE_DIR} ${MVK_MOLTEN_INCLUDE_DIR} ${MVK_VK_INCLUDE_DIR})

	list(REMOVE_DUPLICATES MVK_INCLUDE_DIR)

	include(FindPackageHandleStandardArgs)

	find_package_handle_standard_args(MoltenVK DEFAULT_MSG	MVK_LIBRARIES MVK_VK_INCLUDE_DIR MVK_MOLTEN_INCLUDE_DIR MVK_DATATYPE_INCLUDE_DIR)
