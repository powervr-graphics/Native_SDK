...
/// <summary>Structure describes the number of array levels, mip levels and planes an image contains</summary>
struct ImageLayersSize
{
	...
	uint16_t numPlaneLevels; //!< The number of planes of the range
	...
	/// <param name="numPlaneLevels">The number of plane levels represented by this range. (Default 1).</param>
...
struct ImageStorageFormat : public ImageDataFormat
{
	...
	uint8_t numPlanes; //!<  number of planes
...
struct ImageSubresource
{
	...
	uint16_t planeOffset; //!< The index of the plane. In case of a range, the offset of the first plane.
...
public:
	...
	/// <param name="mipMapLevel">The mip map level for which to get the data pointer (default 0)</param>
	/// <param name="arrayMember">The array member for which to get the data pointer (default 0)</param>
	/// <param name="plane">The plane for which to get the data pointer (default 0)</param>
