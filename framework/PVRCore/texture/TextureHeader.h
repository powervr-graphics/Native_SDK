...
public:
	...
	struct Header
	{
		...
		Header()
			: flags(0), pixelFormat(0), colorSpace(ColorSpace::lRGB), channelType(VariableType::UnsignedByteNorm), height(1), width(1), depth(1), numSurfaces(1), numFaces(1),
			  numMipMaps(1), metaDataSize(0)
		{}
	};
