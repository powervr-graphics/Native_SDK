...
inline TextureMetaData loadTextureMetadataFromStream(Stream& stream)
{
	size_t dataRead = 0;
	...
	if (_dataSize <= 0)
	{
		throw FileIOError("TextureMetadata::loadFromStream: Could not read header from stream.");
	}
...
void TextureReaderPVR::readAsset_(Texture& asset)
{
