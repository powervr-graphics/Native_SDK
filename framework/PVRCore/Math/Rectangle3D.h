...
struct Rectangle3D
{
	...
	glm::detail::tvec3<TYPE, glm::highp> offset() const
	{
		return glm::detail::tvec3<TYPE, glm::highp>(x, y, z);
	}
	...
	glm::detail::tvec3<TYPE, glm::highp> extent() const
	{
		return glm::detail::tvec3<TYPE, glm::highp>(width, height, depth);
	}

	/// <summary>The position of the center of the cuboid.</summary>
	/// <returns>The center of the cuboid</returns>
	glm::detail::tvec3<TYPE, glm::highp> center() const
	{
	...
	Rectangle3D(glm::detail::tvec3<TYPE, glm::precision::defaultp> minimumVertex, glm::detail::tvec3<TYPE, glm::precision::defaultp> dimensions)
