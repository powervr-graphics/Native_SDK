...
struct Rectangle
{
	...
	glm::detail::tvec2<TYPE, glm::highp> offset() const
	{
		return glm::detail::tvec2<TYPE, glm::highp>(x, y);
	}
	...
	glm::detail::tvec2<TYPE, glm::highp> extent() const
	{
		return glm::detail::tvec2<TYPE, glm::highp>(width, height);
	}
	...
	glm::detail::tvec2<TYPE, glm::highp> center() const
	{
