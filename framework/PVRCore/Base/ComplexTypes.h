...
public:
	...
	// Default constructor
	DisplayAttributes()
		: width(800u), height(600u), x(static_cast<uint32_t>(0)), y(static_cast<uint32_t>(0)), depthBPP(32u), stencilBPP(0u), redBits(8u), greenBits(8u), blueBits(8u),
		  alphaBits(8u), aaSamples(0u), configID(0u), vsyncMode(VsyncMode::On), contextPriority(2), swapLength(0), forceColorBPP(false), fullscreen(false), frameBufferSrgb(false)
	{}
