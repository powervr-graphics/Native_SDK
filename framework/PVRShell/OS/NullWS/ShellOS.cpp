...
// Check user input from the available input devices.
	...
	static const SKeyCodeMap testKeys[] = { { 'q', -1 }, { 'Q', -1 }, { VK_ESCAPE, -1 }, { 's', -2 }, { 'S', -2 }, { '1', Key1 }, { '2', Key2 }, { VK_SPACE, KeySpace },
		{ VK_UP, KeyUp }, { VK_DOWN, KeyDown }, { VK_LEFT, KeyLeft }, { VK_RIGHT, KeyRight } };
