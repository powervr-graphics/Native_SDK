...
inline std::string to_string(StreamDescriptorSurfaceCreateFlagsGGP value)
{
	(void)value;
	return "reserved";
}
...
inline std::string to_string(PipelineRasterizationDepthClipStateCreateFlagsEXT value)
{
	(void)value;
	return "reserved";
}
...
inline std::string to_string(MetalSurfaceCreateFlagsEXT value)
{
	(void)value;
	return "reserved";
}
...
inline std::string to_string(PipelineCoverageReductionStateCreateFlagsNV value)
{
	(void)value;
	return "reserved";
}
...
inline std::string to_string(HeadlessSurfaceCreateFlagsEXT value)
{
	(void)value;
	return "reserved";
}
...
inline std::string to_string(Result value)
{
	...
	case Result::e_ERROR_INVALID_DEVICE_ADDRESS_EXT: return "VK_ERROR_INVALID_DEVICE_ADDRESS_EXT";
...
inline std::string to_string(StructureType value)
{
	...
	case StructureType::e_PHYSICAL_DEVICE_SHADER_FLOAT16_INT8_FEATURES_KHR: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT16_INT8_FEATURES_KHR";
	...
	case StructureType::e_PHYSICAL_DEVICE_IMAGELESS_FRAMEBUFFER_FEATURES_KHR: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGELESS_FRAMEBUFFER_FEATURES_KHR";
	case StructureType::e_FRAMEBUFFER_ATTACHMENTS_CREATE_INFO_KHR: return "VK_STRUCTURE_TYPE_FRAMEBUFFER_ATTACHMENTS_CREATE_INFO_KHR";
	case StructureType::e_FRAMEBUFFER_ATTACHMENT_IMAGE_INFO_KHR: return "VK_STRUCTURE_TYPE_FRAMEBUFFER_ATTACHMENT_IMAGE_INFO_KHR";
	case StructureType::e_RENDER_PASS_ATTACHMENT_BEGIN_INFO_KHR: return "VK_STRUCTURE_TYPE_RENDER_PASS_ATTACHMENT_BEGIN_INFO_KHR";
	...
	case StructureType::e_PHYSICAL_DEVICE_FLOAT_CONTROLS_PROPERTIES_KHR: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FLOAT_CONTROLS_PROPERTIES_KHR";
	case StructureType::e_PHYSICAL_DEVICE_DEPTH_STENCIL_RESOLVE_PROPERTIES_KHR: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_STENCIL_RESOLVE_PROPERTIES_KHR";
	case StructureType::e_SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOLVE_KHR: return "VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOLVE_KHR";
	...
	case StructureType::e_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES_EXT: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES_EXT";
	...
	case StructureType::e_BUFFER_DEVICE_ADDRESS_INFO_EXT: return "VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_INFO_EXT";
	...
	case StructureType::e_IMAGE_STENCIL_USAGE_CREATE_INFO_EXT: return "VK_STRUCTURE_TYPE_IMAGE_STENCIL_USAGE_CREATE_INFO_EXT";
	...
	case StructureType::e_PHYSICAL_DEVICE_UNIFORM_BUFFER_STANDARD_LAYOUT_FEATURES_KHR: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_UNIFORM_BUFFER_STANDARD_LAYOUT_FEATURES_KHR";
	...
	case StructureType::e_PHYSICAL_DEVICE_HOST_QUERY_RESET_FEATURES_EXT: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_QUERY_RESET_FEATURES_EXT";
...
inline std::string to_string(FormatFeatureFlags value)
{
	...
	if(static_cast<uint32_t>(value & FormatFeatureFlags::e_SAMPLED_IMAGE_FILTER_CUBIC_BIT_EXT) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_CUBIC_BIT_EXT";
	}
	if(static_cast<uint32_t>(value & FormatFeatureFlags::e_FRAGMENT_DENSITY_MAP_BIT_EXT) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_FORMAT_FEATURE_FRAGMENT_DENSITY_MAP_BIT_EXT";
	}
	return returnString;
}
...
inline std::string to_string(ImageUsageFlags value)
{
	...
	if(static_cast<uint32_t>(value & ImageUsageFlags::e_FRAGMENT_DENSITY_MAP_BIT_EXT) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_IMAGE_USAGE_FRAGMENT_DENSITY_MAP_BIT_EXT";
	}
	return returnString;
}
...
inline std::string to_string(ImageCreateFlags value)
{
	...
	if(static_cast<uint32_t>(value & ImageCreateFlags::e_SUBSAMPLED_BIT_EXT) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_IMAGE_CREATE_SUBSAMPLED_BIT_EXT";
	}
	return returnString;
}
...
inline std::string to_string(MemoryPropertyFlags value)
{
	...
	if(static_cast<uint32_t>(value & MemoryPropertyFlags::e_DEVICE_COHERENT_BIT_AMD) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_MEMORY_PROPERTY_DEVICE_COHERENT_BIT_AMD";
	}
	if(static_cast<uint32_t>(value & MemoryPropertyFlags::e_DEVICE_UNCACHED_BIT_AMD) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_MEMORY_PROPERTY_DEVICE_UNCACHED_BIT_AMD";
	}
	return returnString;
}
...
inline std::string to_string(PipelineStageFlags value)
{
	...
	if(static_cast<uint32_t>(value & PipelineStageFlags::e_FRAGMENT_DENSITY_PROCESS_BIT_EXT) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_PIPELINE_STAGE_FRAGMENT_DENSITY_PROCESS_BIT_EXT";
	}
	return returnString;
}
...
enum class BufferCreateFlags
{
	...
	e_MAX_ENUM = 0x7FFFFFFF,
	e_ALL_BITS = e_SPARSE_BINDING_BIT | e_SPARSE_RESIDENCY_BIT | e_SPARSE_ALIASED_BIT | e_PROTECTED_BIT | e_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_EXT
};
...
inline std::string to_string(BufferCreateFlags value)
{
	...
	if(static_cast<uint32_t>(value & BufferCreateFlags::e_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_EXT) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_EXT";
	}
	return returnString;
}
...
inline std::string to_string(BufferUsageFlags value)
{
	...
	if(static_cast<uint32_t>(value & BufferUsageFlags::e_SHADER_DEVICE_ADDRESS_BIT_EXT) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT_EXT";
	}
	return returnString;
}
...
inline std::string to_string(ImageViewCreateFlags value)
{
	(void)value;
	std::string returnString = "";
	if(static_cast<uint32_t>(value & ImageViewCreateFlags::e_FRAGMENT_DENSITY_MAP_DYNAMIC_BIT_EXT) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_IMAGE_VIEW_CREATE_FRAGMENT_DENSITY_MAP_DYNAMIC_BIT_EXT";
	}
	return returnString;
}
...
enum class ShaderModuleCreateFlags
{
	e_NONE = 0,
	e_MAX_ENUM = 0x7FFFFFFF,
...
enum class PipelineCreateFlags
{
	...
	e_MAX_ENUM = 0x7FFFFFFF,
	e_ALL_BITS = e_DISABLE_OPTIMIZATION_BIT | e_ALLOW_DERIVATIVES_BIT | e_DERIVATIVE_BIT | e_VIEW_INDEX_FROM_DEVICE_INDEX_BIT | e_DISPATCH_BASE | e_VIEW_INDEX_FROM_DEVICE_INDEX_BIT_KHR | e_DISPATCH_BASE_KHR | e_DEFER_COMPILE_BIT_NV | e_CAPTURE_STATISTICS_BIT_KHR | e_CAPTURE_INTERNAL_REPRESENTATIONS_BIT_KHR
};
...
inline std::string to_string(PipelineCreateFlags value)
{
	...
	if(static_cast<uint32_t>(value & PipelineCreateFlags::e_CAPTURE_STATISTICS_BIT_KHR) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_PIPELINE_CREATE_CAPTURE_STATISTICS_BIT_KHR";
	}
	if(static_cast<uint32_t>(value & PipelineCreateFlags::e_CAPTURE_INTERNAL_REPRESENTATIONS_BIT_KHR) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_PIPELINE_CREATE_CAPTURE_INTERNAL_REPRESENTATIONS_BIT_KHR";
	}
	return returnString;
}
...
inline std::string to_string(PipelineShaderStageCreateFlags value)
{
	(void)value;
	std::string returnString = "";
	if(static_cast<uint32_t>(value & PipelineShaderStageCreateFlags::e_ALLOW_VARYING_SUBGROUP_SIZE_BIT_EXT) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_PIPELINE_SHADER_STAGE_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT_EXT";
	}
	if(static_cast<uint32_t>(value & PipelineShaderStageCreateFlags::e_REQUIRE_FULL_SUBGROUPS_BIT_EXT) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_PIPELINE_SHADER_STAGE_CREATE_REQUIRE_FULL_SUBGROUPS_BIT_EXT";
	}
	return returnString;
}
...
inline std::string to_string(SamplerCreateFlags value)
{
	(void)value;
	std::string returnString = "";
	if(static_cast<uint32_t>(value & SamplerCreateFlags::e_SUBSAMPLED_BIT_EXT) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_SAMPLER_CREATE_SUBSAMPLED_BIT_EXT";
	}
	if(static_cast<uint32_t>(value & SamplerCreateFlags::e_SUBSAMPLED_COARSE_RECONSTRUCTION_BIT_EXT) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_SAMPLER_CREATE_SUBSAMPLED_COARSE_RECONSTRUCTION_BIT_EXT";
	}
	return returnString;
}
...
enum class FramebufferCreateFlags
{
	...
	e_MAX_ENUM = 0x7FFFFFFF,
	e_ALL_BITS = e_IMAGELESS_BIT_KHR
};
...
inline std::string to_string(FramebufferCreateFlags value)
{
	(void)value;
	std::string returnString = "";
	if(static_cast<uint32_t>(value & FramebufferCreateFlags::e_IMAGELESS_BIT_KHR) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_FRAMEBUFFER_CREATE_IMAGELESS_BIT_KHR";
	}
	return returnString;
}
...
inline std::string to_string(AccessFlags value)
{
	...
	if(static_cast<uint32_t>(value & AccessFlags::e_FRAGMENT_DENSITY_MAP_READ_BIT_EXT) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_ACCESS_FRAGMENT_DENSITY_MAP_READ_BIT_EXT";
	}
	return returnString;
}
...
enum class StencilFaceFlags
{
	...
	e_MAX_ENUM = 0x7FFFFFFF,
	e_ALL_BITS = e_FRONT_BIT | e_BACK_BIT | e_FRONT_AND_BACK | e_VK_STENCIL_FRONT_AND_BACK
};
...
inline std::string to_string(StencilFaceFlags value)
{
	...
	if(static_cast<uint32_t>(value & StencilFaceFlags::e_FRONT_AND_BACK) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_STENCIL_FACE_FRONT_AND_BACK";
	}
...
inline std::string to_string(SwapchainCreateFlagsKHR value)
{
	...
	if(static_cast<uint32_t>(value & SwapchainCreateFlagsKHR::e_MUTABLE_FORMAT_BIT_KHR) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_SWAPCHAIN_CREATE_MUTABLE_FORMAT_BIT_KHR";
	}
	return returnString;
}
...
inline std::string to_string(DriverIdKHR value)
{
	...
	case DriverIdKHR::e_GOOGLE_SWIFTSHADER_KHR: return "VK_DRIVER_ID_GOOGLE_SWIFTSHADER_KHR";
	case DriverIdKHR::e_GGP_PROPRIETARY_KHR: return "VK_DRIVER_ID_GGP_PROPRIETARY_KHR";
	case DriverIdKHR::e_BROADCOM_PROPRIETARY_KHR: return "VK_DRIVER_ID_BROADCOM_PROPRIETARY_KHR";
	default: return "invalid";
	}
}
...
enum class ShaderFloatControlsIndependenceKHR
{
	...
	e_BEGIN_RANGE = VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_BEGIN_RANGE_KHR,
	e_END_RANGE = VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_END_RANGE_KHR,
	e_RANGE_SIZE = VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_RANGE_SIZE_KHR,
	e_MAX_ENUM = 0x7FFFFFFF

};
DEFINE_ENUM_BITWISE_OPERATORS(ShaderFloatControlsIndependenceKHR)
inline std::string to_string(ShaderFloatControlsIndependenceKHR value)
{
	switch(value)
	{
	case ShaderFloatControlsIndependenceKHR::e_32_BIT_ONLY_KHR: return "VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_32_BIT_ONLY_KHR";
	case ShaderFloatControlsIndependenceKHR::e_ALL_KHR: return "VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_ALL_KHR";
	case ShaderFloatControlsIndependenceKHR::e_NONE_KHR: return "VK_SHADER_FLOAT_CONTROLS_INDEPENDENCE_NONE_KHR";
	default: return "invalid";
	}
}

enum class ResolveModeFlagsKHR
{
	e_NONE = 0,
	...
	e_MAX_ENUM = 0x7FFFFFFF,
	e_ALL_BITS = e_NONE_KHR | e_SAMPLE_ZERO_BIT_KHR | e_AVERAGE_BIT_KHR | e_MIN_BIT_KHR | e_MAX_BIT_KHR
};
DEFINE_ENUM_BITWISE_OPERATORS(ResolveModeFlagsKHR)
inline std::string to_string(ResolveModeFlagsKHR value)
{
	(void)value;
	std::string returnString = "";
	if(static_cast<uint32_t>(value & ResolveModeFlagsKHR::e_NONE_KHR) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_RESOLVE_MODE_NONE_KHR";
	}
	if(static_cast<uint32_t>(value & ResolveModeFlagsKHR::e_SAMPLE_ZERO_BIT_KHR) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_RESOLVE_MODE_SAMPLE_ZERO_BIT_KHR";
	}
	if(static_cast<uint32_t>(value & ResolveModeFlagsKHR::e_AVERAGE_BIT_KHR) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_RESOLVE_MODE_AVERAGE_BIT_KHR";
	}
	if(static_cast<uint32_t>(value & ResolveModeFlagsKHR::e_MIN_BIT_KHR) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_RESOLVE_MODE_MIN_BIT_KHR";
	}
	if(static_cast<uint32_t>(value & ResolveModeFlagsKHR::e_MAX_BIT_KHR) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_RESOLVE_MODE_MAX_BIT_KHR";
	}
	return returnString;
}
...
enum class PipelineCompilerControlFlagsAMD
{
	e_NONE = 0,
	e_MAX_ENUM = 0x7FFFFFFF,
...
inline std::string to_string(PipelineCompilerControlFlagsAMD value)
{
	(void)value;
	std::string returnString = "";
	return returnString;
...
inline std::string to_string(PipelineCreationFeedbackFlagsEXT value)
{
	(void)value;
	std::string returnString = "";
	if(static_cast<uint32_t>(value & PipelineCreationFeedbackFlagsEXT::e_VALID_BIT_EXT) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_PIPELINE_CREATION_FEEDBACK_VALID_BIT_EXT";
	}
	if(static_cast<uint32_t>(value & PipelineCreationFeedbackFlagsEXT::e_APPLICATION_PIPELINE_CACHE_HIT_BIT_EXT) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_PIPELINE_CREATION_FEEDBACK_APPLICATION_PIPELINE_CACHE_HIT_BIT_EXT";
	}
	if(static_cast<uint32_t>(value & PipelineCreationFeedbackFlagsEXT::e_BASE_PIPELINE_ACCELERATION_BIT_EXT) != 0)
	{
		if(!returnString.empty())
		{
			returnString += " | ";
		}
		returnString += "VK_PIPELINE_CREATION_FEEDBACK_BASE_PIPELINE_ACCELERATION_BIT_EXT";
	}
	return returnString;
}
...
enum class ShaderCorePropertiesFlagsAMD
{
	e_NONE = 0,
	e_MAX_ENUM = 0x7FFFFFFF,
...
inline std::string to_string(ShaderCorePropertiesFlagsAMD value)
{
	(void)value;
	std::string returnString = "";
	return returnString;
...
// PVRVk ObjectType conversion functions: convertObjectTypeToDebugReportObjectType()
inline DebugReportObjectTypeEXT convertObjectTypeToDebugReportObjectType(ObjectType objectType)
{
	switch(objectType)
	{
	case ObjectType::e_UNKNOWN: return DebugReportObjectTypeEXT::e_UNKNOWN_EXT;
	case ObjectType::e_INSTANCE: return DebugReportObjectTypeEXT::e_INSTANCE_EXT;
	case ObjectType::e_PHYSICAL_DEVICE: return DebugReportObjectTypeEXT::e_PHYSICAL_DEVICE_EXT;
	case ObjectType::e_DEVICE: return DebugReportObjectTypeEXT::e_DEVICE_EXT;
	case ObjectType::e_QUEUE: return DebugReportObjectTypeEXT::e_QUEUE_EXT;
	case ObjectType::e_SEMAPHORE: return DebugReportObjectTypeEXT::e_SEMAPHORE_EXT;
	case ObjectType::e_COMMAND_BUFFER: return DebugReportObjectTypeEXT::e_COMMAND_BUFFER_EXT;
	case ObjectType::e_FENCE: return DebugReportObjectTypeEXT::e_FENCE_EXT;
	case ObjectType::e_DEVICE_MEMORY: return DebugReportObjectTypeEXT::e_DEVICE_MEMORY_EXT;
	case ObjectType::e_BUFFER: return DebugReportObjectTypeEXT::e_BUFFER_EXT;
	case ObjectType::e_IMAGE: return DebugReportObjectTypeEXT::e_IMAGE_EXT;
	case ObjectType::e_EVENT: return DebugReportObjectTypeEXT::e_EVENT_EXT;
	case ObjectType::e_QUERY_POOL: return DebugReportObjectTypeEXT::e_QUERY_POOL_EXT;
	case ObjectType::e_BUFFER_VIEW: return DebugReportObjectTypeEXT::e_BUFFER_VIEW_EXT;
	case ObjectType::e_IMAGE_VIEW: return DebugReportObjectTypeEXT::e_IMAGE_VIEW_EXT;
	case ObjectType::e_SHADER_MODULE: return DebugReportObjectTypeEXT::e_SHADER_MODULE_EXT;
	case ObjectType::e_PIPELINE_CACHE: return DebugReportObjectTypeEXT::e_PIPELINE_CACHE_EXT;
	case ObjectType::e_PIPELINE_LAYOUT: return DebugReportObjectTypeEXT::e_PIPELINE_LAYOUT_EXT;
	case ObjectType::e_RENDER_PASS: return DebugReportObjectTypeEXT::e_RENDER_PASS_EXT;
	case ObjectType::e_PIPELINE: return DebugReportObjectTypeEXT::e_PIPELINE_EXT;
	case ObjectType::e_DESCRIPTOR_SET_LAYOUT: return DebugReportObjectTypeEXT::e_DESCRIPTOR_SET_LAYOUT_EXT;
	case ObjectType::e_SAMPLER: return DebugReportObjectTypeEXT::e_SAMPLER_EXT;
	case ObjectType::e_DESCRIPTOR_POOL: return DebugReportObjectTypeEXT::e_DESCRIPTOR_POOL_EXT;
	case ObjectType::e_DESCRIPTOR_SET: return DebugReportObjectTypeEXT::e_DESCRIPTOR_SET_EXT;
	case ObjectType::e_FRAMEBUFFER: return DebugReportObjectTypeEXT::e_FRAMEBUFFER_EXT;
	case ObjectType::e_COMMAND_POOL: return DebugReportObjectTypeEXT::e_COMMAND_POOL_EXT;
	case ObjectType::e_SAMPLER_YCBCR_CONVERSION: return DebugReportObjectTypeEXT::e_SAMPLER_YCBCR_CONVERSION_EXT;
	case ObjectType::e_DESCRIPTOR_UPDATE_TEMPLATE: return DebugReportObjectTypeEXT::e_DESCRIPTOR_UPDATE_TEMPLATE_EXT;
	case ObjectType::e_SURFACE_KHR: return DebugReportObjectTypeEXT::e_SURFACE_KHR_EXT;
	case ObjectType::e_SWAPCHAIN_KHR: return DebugReportObjectTypeEXT::e_SWAPCHAIN_KHR_EXT;
	case ObjectType::e_DISPLAY_KHR: return DebugReportObjectTypeEXT::e_DISPLAY_KHR_EXT;
	case ObjectType::e_DISPLAY_MODE_KHR: return DebugReportObjectTypeEXT::e_DISPLAY_MODE_KHR_EXT;
	case ObjectType::e_OBJECT_TABLE_NVX: return DebugReportObjectTypeEXT::e_OBJECT_TABLE_NVX_EXT;
	case ObjectType::e_INDIRECT_COMMANDS_LAYOUT_NVX: return DebugReportObjectTypeEXT::e_INDIRECT_COMMANDS_LAYOUT_NVX_EXT;
	case ObjectType::e_ACCELERATION_STRUCTURE_NV: return DebugReportObjectTypeEXT::e_ACCELERATION_STRUCTURE_NV_EXT;
	default: return DebugReportObjectTypeEXT::e_UNKNOWN_EXT;
	}
}
// PVRVk DebugReportObjectTypeEXT conversion functions: convertDebugReportObjectTypeToObjectType()
inline ObjectType convertDebugReportObjectTypeToObjectType(DebugReportObjectTypeEXT debugReportObjectType)
{
	switch(debugReportObjectType)
	{
	case DebugReportObjectTypeEXT::e_UNKNOWN_EXT: return ObjectType::e_UNKNOWN;
	case DebugReportObjectTypeEXT::e_INSTANCE_EXT: return ObjectType::e_INSTANCE;
	case DebugReportObjectTypeEXT::e_PHYSICAL_DEVICE_EXT: return ObjectType::e_PHYSICAL_DEVICE;
	case DebugReportObjectTypeEXT::e_DEVICE_EXT: return ObjectType::e_DEVICE;
	case DebugReportObjectTypeEXT::e_QUEUE_EXT: return ObjectType::e_QUEUE;
	case DebugReportObjectTypeEXT::e_SEMAPHORE_EXT: return ObjectType::e_SEMAPHORE;
	case DebugReportObjectTypeEXT::e_COMMAND_BUFFER_EXT: return ObjectType::e_COMMAND_BUFFER;
	case DebugReportObjectTypeEXT::e_FENCE_EXT: return ObjectType::e_FENCE;
	case DebugReportObjectTypeEXT::e_DEVICE_MEMORY_EXT: return ObjectType::e_DEVICE_MEMORY;
	case DebugReportObjectTypeEXT::e_BUFFER_EXT: return ObjectType::e_BUFFER;
	case DebugReportObjectTypeEXT::e_IMAGE_EXT: return ObjectType::e_IMAGE;
	case DebugReportObjectTypeEXT::e_EVENT_EXT: return ObjectType::e_EVENT;
	case DebugReportObjectTypeEXT::e_QUERY_POOL_EXT: return ObjectType::e_QUERY_POOL;
	case DebugReportObjectTypeEXT::e_BUFFER_VIEW_EXT: return ObjectType::e_BUFFER_VIEW;
	case DebugReportObjectTypeEXT::e_IMAGE_VIEW_EXT: return ObjectType::e_IMAGE_VIEW;
	case DebugReportObjectTypeEXT::e_SHADER_MODULE_EXT: return ObjectType::e_SHADER_MODULE;
	case DebugReportObjectTypeEXT::e_PIPELINE_CACHE_EXT: return ObjectType::e_PIPELINE_CACHE;
	case DebugReportObjectTypeEXT::e_PIPELINE_LAYOUT_EXT: return ObjectType::e_PIPELINE_LAYOUT;
	case DebugReportObjectTypeEXT::e_RENDER_PASS_EXT: return ObjectType::e_RENDER_PASS;
	case DebugReportObjectTypeEXT::e_PIPELINE_EXT: return ObjectType::e_PIPELINE;
	case DebugReportObjectTypeEXT::e_DESCRIPTOR_SET_LAYOUT_EXT: return ObjectType::e_DESCRIPTOR_SET_LAYOUT;
	case DebugReportObjectTypeEXT::e_SAMPLER_EXT: return ObjectType::e_SAMPLER;
	case DebugReportObjectTypeEXT::e_DESCRIPTOR_POOL_EXT: return ObjectType::e_DESCRIPTOR_POOL;
	case DebugReportObjectTypeEXT::e_DESCRIPTOR_SET_EXT: return ObjectType::e_DESCRIPTOR_SET;
	case DebugReportObjectTypeEXT::e_FRAMEBUFFER_EXT: return ObjectType::e_FRAMEBUFFER;
	case DebugReportObjectTypeEXT::e_COMMAND_POOL_EXT: return ObjectType::e_COMMAND_POOL;
	case DebugReportObjectTypeEXT::e_SURFACE_KHR_EXT: return ObjectType::e_SURFACE_KHR;
	case DebugReportObjectTypeEXT::e_SWAPCHAIN_KHR_EXT: return ObjectType::e_SWAPCHAIN_KHR;
	case DebugReportObjectTypeEXT::e_DISPLAY_KHR_EXT: return ObjectType::e_DISPLAY_KHR;
	case DebugReportObjectTypeEXT::e_DISPLAY_MODE_KHR_EXT: return ObjectType::e_DISPLAY_MODE_KHR;
	case DebugReportObjectTypeEXT::e_OBJECT_TABLE_NVX_EXT: return ObjectType::e_OBJECT_TABLE_NVX;
	case DebugReportObjectTypeEXT::e_INDIRECT_COMMANDS_LAYOUT_NVX_EXT: return ObjectType::e_INDIRECT_COMMANDS_LAYOUT_NVX;
	case DebugReportObjectTypeEXT::e_SAMPLER_YCBCR_CONVERSION_EXT: return ObjectType::e_SAMPLER_YCBCR_CONVERSION;
	case DebugReportObjectTypeEXT::e_DESCRIPTOR_UPDATE_TEMPLATE_EXT: return ObjectType::e_DESCRIPTOR_UPDATE_TEMPLATE;
	case DebugReportObjectTypeEXT::e_ACCELERATION_STRUCTURE_NV_EXT: return ObjectType::e_ACCELERATION_STRUCTURE_NV;
	default: return ObjectType::e_UNKNOWN;
	}
}
...
struct AllocationCallbacks : private VkAllocationCallbacks
{
	...
	inline void setPfnAllocation(const PFN_vkAllocationFunction& inPfnAllocation) { this->pfnAllocation = inPfnAllocation; }
	inline PFN_vkReallocationFunction getPfnReallocation() const { return pfnReallocation; }
	inline void setPfnReallocation(const PFN_vkReallocationFunction& inPfnReallocation) { this->pfnReallocation = inPfnReallocation; }
	inline PFN_vkFreeFunction getPfnFree() const { return pfnFree; }
	inline void setPfnFree(const PFN_vkFreeFunction& inPfnFree) { this->pfnFree = inPfnFree; }
	inline PFN_vkInternalAllocationNotification getPfnInternalAllocation() const { return pfnInternalAllocation; }
	inline void setPfnInternalAllocation(const PFN_vkInternalAllocationNotification& inPfnInternalAllocation) { this->pfnInternalAllocation = inPfnInternalAllocation; }
	inline PFN_vkInternalFreeNotification getPfnInternalFree() const { return pfnInternalFree; }
	inline void setPfnInternalFree(const PFN_vkInternalFreeNotification& inPfnInternalFree) { this->pfnInternalFree = inPfnInternalFree; }
...
struct ImageBlit : private VkImageBlit
{
	...
	inline void setSrcOffsets(const Offset3D& inSrcOffsets, const uint32_t index) { memcpy(this->srcOffsets + index, &inSrcOffsets + index, sizeof(inSrcOffsets)); }
	inline const ImageSubresourceLayers& getDstSubresource() const { return (ImageSubresourceLayers&)dstSubresource; }
	inline void setDstSubresource(const ImageSubresourceLayers& inDstSubresource) { memcpy(&this->dstSubresource, &inDstSubresource, sizeof(this->dstSubresource)); }
	...
	inline void setDstOffsets(const Offset3D& inDstOffsets, const uint32_t index) { memcpy(this->dstOffsets + index, &inDstOffsets + index, sizeof(inDstOffsets)); }
...
public:
	...
	inline const double& getF64() const { return _PipelineExecutableStatisticValueKHR.f64; }
...
struct IndirectCommandsTokenNVX : private VkIndirectCommandsTokenNVX
{
	...
	inline void setBuffer(const VkBuffer& inBuffer) { this->buffer = inBuffer; }
	inline VkDeviceSize getOffset() const { return offset; }
...
struct ObjectTablePipelineEntryNVX : private VkObjectTablePipelineEntryNVX
{
	...
	inline void setPipeline(const VkPipeline& inPipeline) { this->pipeline = inPipeline; }
...
struct ObjectTableDescriptorSetEntryNVX : private VkObjectTableDescriptorSetEntryNVX
{
	...
	inline void setPipelineLayout(const VkPipelineLayout& inPipelineLayout) { this->pipelineLayout = inPipelineLayout; }
	inline const VkDescriptorSet& getDescriptorSet() const { return descriptorSet; }
	inline void setDescriptorSet(const VkDescriptorSet& inDescriptorSet) { this->descriptorSet = inDescriptorSet; }
...
struct AttachmentSampleLocationsEXT : private VkAttachmentSampleLocationsEXT
{
	...
	inline void setSampleLocationsInfo(const VkSampleLocationsInfoEXT& inSampleLocationsInfo) { this->sampleLocationsInfo = inSampleLocationsInfo; }
...
struct GeometryDataNV : private VkGeometryDataNV
{
	...
	inline void setTriangles(const VkGeometryTrianglesNV& inTriangles) { this->triangles = inTriangles; }
	inline const VkGeometryAABBNV& getAabbs() const { return aabbs; }
	inline void setAabbs(const VkGeometryAABBNV& inAabbs) { this->aabbs = inAabbs; }
...
public:
	...
	ErrorUnknown(const char* errorMessage = nullptr) : Error(ResultUnknownError, errorMessage) {}
...
public:
	...
	ErrorOutOfPoolMemoryKHR(const char* errorMessage = nullptr) : Error(Result::e_ERROR_OUT_OF_POOL_MEMORY_KHR, errorMessage) {}
...
public:
	...
	ErrorInvalidExternalHandleKHR(const char* errorMessage = nullptr) : Error(Result::e_ERROR_INVALID_EXTERNAL_HANDLE_KHR, errorMessage) {}
...
public:
	...
	ErrorFragmentationEXT(const char* errorMessage = nullptr) : Error(Result::e_ERROR_FRAGMENTATION_EXT, errorMessage) {}
...
class ErrorInvalidDeviceAddressEXT: public Error
{
public:
	virtual ~ErrorInvalidDeviceAddressEXT() {}
	ErrorInvalidDeviceAddressEXT(const char* errorMessage = nullptr) : Error(Result::e_ERROR_INVALID_DEVICE_ADDRESS_EXT, errorMessage) {}
	explicit ErrorInvalidDeviceAddressEXT(const std::string& errorMessage) : Error(Result::e_ERROR_INVALID_DEVICE_ADDRESS_EXT, errorMessage) {}
};
...
inline void vkThrowIfFailed(Result result, const char* message = 0)
{
	...
	case Result::e_ERROR_INVALID_DEVICE_ADDRESS_EXT: throw ErrorInvalidDeviceAddressEXT(message);
...
public:
	...
	// VK_MVK_ios_surface
	bool miosSurfaceEnabled = false;
	// VK_MVK_macos_surface
	bool mmacosSurfaceEnabled = false;
	// VK_EXT_debug_utils
...
void setEnabledExtension(const std::string& extension)
{
	std::string deviceExtensions[153] = {
		"VK_KHR_swapchain",
		"VK_KHR_display_swapchain",
		"VK_KHR_sampler_mirror_clamp_to_edge",
		"VK_KHR_multiview",
	...
	bool* deviceExtensionsFlags[153] = {
		&khrSwapchainEnabled,
