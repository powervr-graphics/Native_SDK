...
inline std::string to_string(StructureType value)
{
    ...
    case StructureType::e_PHYSICAL_DEVICE_FLOAT16_INT8_FEATURES_KHR: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FLOAT16_INT8_FEATURES_KHR";
    ...
    case StructureType::e_PHYSICAL_DEVICE_BUFFER_ADDRESS_FEATURES_EXT: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_ADDRESS_FEATURES_EXT";
...
enum class DriverIdKHR
{
    ...
    e_GOOGLE_PASTEL_KHR = VK_DRIVER_ID_GOOGLE_PASTEL_KHR,
...
inline std::string to_string(DriverIdKHR value)
{
    ...
    case DriverIdKHR::e_GOOGLE_PASTEL_KHR: return "VK_DRIVER_ID_GOOGLE_PASTEL_KHR";
    default: return "invalid";
    }
}
...
{
    std::string instanceExtensions[27] = {
        "VK_KHR_display",
        "VK_KHR_get_physical_device_properties2",
        "VK_EXT_direct_mode_display",
        "VK_KHR_surface",
    ...
    bool* instanceExtensionsFlags[27] = {
        &khrDisplayEnabled,
...
void setEnabledExtension(const std::string& extension)
{
    std::string deviceExtensions[127] = {
        "VK_KHR_image_format_list",
        "VK_NV_glsl_shader",
        "VK_AMD_shader_ballot",
        "VK_EXT_debug_marker",
    ...
    bool* deviceExtensionsFlags[127] = {
