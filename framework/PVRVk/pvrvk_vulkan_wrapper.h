...
enum class DirectFBSurfaceCreateFlagsEXT: uint32_t { e_NONE };
DEFINE_ENUM_BITWISE_OPERATORS(DirectFBSurfaceCreateFlagsEXT)
DEFINE_EMPTY_TO_STRING(DirectFBSurfaceCreateFlagsEXT)
...
enum class DeviceMemoryReportFlagsEXT: uint32_t { e_NONE };
DEFINE_ENUM_BITWISE_OPERATORS(DeviceMemoryReportFlagsEXT)
DEFINE_EMPTY_TO_STRING(DeviceMemoryReportFlagsEXT)
...
enum class AccessFlags
{
	...
	e_ALL_BITS = e_INDIRECT_COMMAND_READ_BIT|e_INDEX_READ_BIT|e_VERTEX_ATTRIBUTE_READ_BIT|e_UNIFORM_READ_BIT|e_INPUT_ATTACHMENT_READ_BIT|e_SHADER_READ_BIT|e_SHADER_WRITE_BIT|e_COLOR_ATTACHMENT_READ_BIT|e_COLOR_ATTACHMENT_WRITE_BIT|e_DEPTH_STENCIL_ATTACHMENT_READ_BIT|e_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT|e_TRANSFER_READ_BIT|e_TRANSFER_WRITE_BIT|e_HOST_READ_BIT|e_HOST_WRITE_BIT|e_MEMORY_READ_BIT|e_MEMORY_WRITE_BIT|e_COMMAND_PREPROCESS_READ_BIT_NV|e_COMMAND_PREPROCESS_WRITE_BIT_NV|e_COLOR_ATTACHMENT_READ_NONCOHERENT_BIT_EXT|e_CONDITIONAL_RENDERING_READ_BIT_EXT|e_ACCELERATION_STRUCTURE_READ_BIT_KHR|e_ACCELERATION_STRUCTURE_WRITE_BIT_KHR|e_SHADING_RATE_IMAGE_READ_BIT_NV|e_FRAGMENT_DENSITY_MAP_READ_BIT_EXT|e_TRANSFORM_FEEDBACK_WRITE_BIT_EXT|e_TRANSFORM_FEEDBACK_COUNTER_READ_BIT_EXT|e_TRANSFORM_FEEDBACK_COUNTER_WRITE_BIT_EXT,
	e_MAX_ENUM = 0x7FFFFFFF
};
...
enum class BufferUsageFlags
{
	...
	e_ALL_BITS = e_TRANSFER_SRC_BIT|e_TRANSFER_DST_BIT|e_UNIFORM_TEXEL_BUFFER_BIT|e_STORAGE_TEXEL_BUFFER_BIT|e_UNIFORM_BUFFER_BIT|e_STORAGE_BUFFER_BIT|e_INDEX_BUFFER_BIT|e_VERTEX_BUFFER_BIT|e_INDIRECT_BUFFER_BIT|e_CONDITIONAL_RENDERING_BIT_EXT|e_SHADER_BINDING_TABLE_BIT_KHR|e_TRANSFORM_FEEDBACK_BUFFER_BIT_EXT|e_TRANSFORM_FEEDBACK_COUNTER_BUFFER_BIT_EXT|e_SHADER_DEVICE_ADDRESS_BIT|e_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR|e_ACCELERATION_STRUCTURE_STORAGE_BIT_KHR,
	e_MAX_ENUM = 0x7FFFFFFF
};
...
enum class ImageViewCreateFlags
{
	...
	e_FRAGMENT_DENSITY_MAP_DEFERRED_BIT_EXT = VK_IMAGE_VIEW_CREATE_FRAGMENT_DENSITY_MAP_DEFERRED_BIT_EXT,
	e_ALL_BITS = e_FRAGMENT_DENSITY_MAP_DYNAMIC_BIT_EXT|e_FRAGMENT_DENSITY_MAP_DEFERRED_BIT_EXT,
	e_MAX_ENUM = 0x7FFFFFFF
};
...
inline std::string to_string(ImageViewCreateFlags value)
{
	...
	append_to_string_flag(value, returnString, ImageViewCreateFlags::e_FRAGMENT_DENSITY_MAP_DEFERRED_BIT_EXT, "VK_IMAGE_VIEW_CREATE_FRAGMENT_DENSITY_MAP_DEFERRED_BIT_EXT");
	return returnString;
}
...
inline std::string to_string(PipelineCreateFlags value)
{
	...
	append_to_string_flag(value, returnString, PipelineCreateFlags::e_RAY_TRACING_SHADER_GROUP_HANDLE_CAPTURE_REPLAY_BIT_KHR, "VK_PIPELINE_CREATE_RAY_TRACING_SHADER_GROUP_HANDLE_CAPTURE_REPLAY_BIT_KHR");
	return returnString;
}
...
inline std::string to_string(FormatFeatureFlags value)
{
	...
	append_to_string_flag(value, returnString, FormatFeatureFlags::e_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR, "VK_FORMAT_FEATURE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR");
	return returnString;
}
...
{
	std::string returnString = "";
	append_to_string_flag(value, returnString, SurfaceCounterFlagsEXT::e_VBLANK_BIT_EXT, "VK_SURFACE_COUNTER_VBLANK_BIT_EXT");
	return returnString;
}
...
enum class AccelerationStructureCreateFlagsKHR
{
	e_NONE = 0,
	e_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR = VK_ACCELERATION_STRUCTURE_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR,
	e_ALL_BITS = e_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR,
	e_MAX_ENUM = 0x7FFFFFFF
};
DEFINE_ENUM_BITWISE_OPERATORS(AccelerationStructureCreateFlagsKHR)
inline std::string to_string(AccelerationStructureCreateFlagsKHR value)
{
	std::string returnString = "";
	append_to_string_flag(value, returnString, AccelerationStructureCreateFlagsKHR::e_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR, "VK_ACCELERATION_STRUCTURE_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR");
	return returnString;
}
...
enum class PerformanceCounterDescriptionFlagsKHR
{
	...
	e_ALL_BITS = e_PERFORMANCE_IMPACTING_BIT_KHR|e_CONCURRENTLY_IMPACTED_BIT_KHR,
	e_MAX_ENUM = 0x7FFFFFFF
};
...
{
	std::string returnString = "";
	append_to_string_flag(value, returnString, PerformanceCounterDescriptionFlagsKHR::e_PERFORMANCE_IMPACTING_BIT_KHR, "VK_PERFORMANCE_COUNTER_DESCRIPTION_PERFORMANCE_IMPACTING_BIT_KHR");
	append_to_string_flag(value, returnString, PerformanceCounterDescriptionFlagsKHR::e_CONCURRENTLY_IMPACTED_BIT_KHR, "VK_PERFORMANCE_COUNTER_DESCRIPTION_CONCURRENTLY_IMPACTED_BIT_KHR");
	return returnString;
}
...
inline std::string to_string(Format value)
{
	...
	case Format::e_A4R4G4B4_UNORM_PACK16_EXT: return "VK_FORMAT_A4R4G4B4_UNORM_PACK16_EXT";
	case Format::e_A4B4G4R4_UNORM_PACK16_EXT: return "VK_FORMAT_A4B4G4R4_UNORM_PACK16_EXT";
	default: return "invalid";
	}
}
...
inline std::string to_string(StructureType value)
{
	...
	case StructureType::e_PHYSICAL_DEVICE_PORTABILITY_SUBSET_FEATURES_KHR: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PORTABILITY_SUBSET_FEATURES_KHR";
	case StructureType::e_PHYSICAL_DEVICE_PORTABILITY_SUBSET_PROPERTIES_KHR: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PORTABILITY_SUBSET_PROPERTIES_KHR";
	...
	case StructureType::e_PHYSICAL_DEVICE_SHADER_TERMINATE_INVOCATION_FEATURES_KHR: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_TERMINATE_INVOCATION_FEATURES_KHR";
	...
	case StructureType::e_PHYSICAL_DEVICE_SHADER_IMAGE_ATOMIC_INT64_FEATURES_EXT: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_IMAGE_ATOMIC_INT64_FEATURES_EXT";
	...
	case StructureType::e_PHYSICAL_DEVICE_SHADER_ATOMIC_FLOAT_FEATURES_EXT: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_FLOAT_FEATURES_EXT";
	...
	case StructureType::e_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_FEATURES_EXT: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_FEATURES_EXT";
	...
	case StructureType::e_PHYSICAL_DEVICE_DEVICE_MEMORY_REPORT_FEATURES_EXT: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_MEMORY_REPORT_FEATURES_EXT";
	case StructureType::e_DEVICE_DEVICE_MEMORY_REPORT_CREATE_INFO_EXT: return "VK_STRUCTURE_TYPE_DEVICE_DEVICE_MEMORY_REPORT_CREATE_INFO_EXT";
	case StructureType::e_DEVICE_MEMORY_REPORT_CALLBACK_DATA_EXT: return "VK_STRUCTURE_TYPE_DEVICE_MEMORY_REPORT_CALLBACK_DATA_EXT";
	...
	case StructureType::e_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_ENUMS_PROPERTIES_NV: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_ENUMS_PROPERTIES_NV";
	case StructureType::e_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_ENUMS_FEATURES_NV: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_ENUMS_FEATURES_NV";
	case StructureType::e_PIPELINE_FRAGMENT_SHADING_RATE_ENUM_STATE_CREATE_INFO_NV: return "VK_STRUCTURE_TYPE_PIPELINE_FRAGMENT_SHADING_RATE_ENUM_STATE_CREATE_INFO_NV";
	case StructureType::e_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_2_FEATURES_EXT: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_2_FEATURES_EXT";
	case StructureType::e_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_2_PROPERTIES_EXT: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_2_PROPERTIES_EXT";
	case StructureType::e_COPY_COMMAND_TRANSFORM_INFO_QCOM: return "VK_STRUCTURE_TYPE_COPY_COMMAND_TRANSFORM_INFO_QCOM";
	case StructureType::e_PHYSICAL_DEVICE_IMAGE_ROBUSTNESS_FEATURES_EXT: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_ROBUSTNESS_FEATURES_EXT";
	case StructureType::e_COPY_BUFFER_INFO_2_KHR: return "VK_STRUCTURE_TYPE_COPY_BUFFER_INFO_2_KHR";
	case StructureType::e_COPY_IMAGE_INFO_2_KHR: return "VK_STRUCTURE_TYPE_COPY_IMAGE_INFO_2_KHR";
	case StructureType::e_COPY_BUFFER_TO_IMAGE_INFO_2_KHR: return "VK_STRUCTURE_TYPE_COPY_BUFFER_TO_IMAGE_INFO_2_KHR";
	case StructureType::e_COPY_IMAGE_TO_BUFFER_INFO_2_KHR: return "VK_STRUCTURE_TYPE_COPY_IMAGE_TO_BUFFER_INFO_2_KHR";
	case StructureType::e_BLIT_IMAGE_INFO_2_KHR: return "VK_STRUCTURE_TYPE_BLIT_IMAGE_INFO_2_KHR";
	case StructureType::e_RESOLVE_IMAGE_INFO_2_KHR: return "VK_STRUCTURE_TYPE_RESOLVE_IMAGE_INFO_2_KHR";
	case StructureType::e_BUFFER_COPY_2_KHR: return "VK_STRUCTURE_TYPE_BUFFER_COPY_2_KHR";
	case StructureType::e_IMAGE_COPY_2_KHR: return "VK_STRUCTURE_TYPE_IMAGE_COPY_2_KHR";
	case StructureType::e_IMAGE_BLIT_2_KHR: return "VK_STRUCTURE_TYPE_IMAGE_BLIT_2_KHR";
	case StructureType::e_BUFFER_IMAGE_COPY_2_KHR: return "VK_STRUCTURE_TYPE_BUFFER_IMAGE_COPY_2_KHR";
	case StructureType::e_IMAGE_RESOLVE_2_KHR: return "VK_STRUCTURE_TYPE_IMAGE_RESOLVE_2_KHR";
	case StructureType::e_PHYSICAL_DEVICE_4444_FORMATS_FEATURES_EXT: return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_4444_FORMATS_FEATURES_EXT";
	case StructureType::e_DIRECTFB_SURFACE_CREATE_INFO_EXT: return "VK_STRUCTURE_TYPE_DIRECTFB_SURFACE_CREATE_INFO_EXT";
...
inline std::string to_string(DebugReportObjectTypeEXT value)
{
	...
	case DebugReportObjectTypeEXT::e_ACCELERATION_STRUCTURE_KHR_EXT: return "VK_DEBUG_REPORT_OBJECT_TYPE_ACCELERATION_STRUCTURE_KHR_EXT";
...
DEFINE_ENUM_BITWISE_OPERATORS(DeviceMemoryReportEventTypeEXT)
inline std::string to_string(DeviceMemoryReportEventTypeEXT value)
{
	switch(value)
	{
	case DeviceMemoryReportEventTypeEXT::e_ALLOCATE_EXT: return "VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_ALLOCATE_EXT";
	case DeviceMemoryReportEventTypeEXT::e_FREE_EXT: return "VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_FREE_EXT";
	case DeviceMemoryReportEventTypeEXT::e_IMPORT_EXT: return "VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_IMPORT_EXT";
	case DeviceMemoryReportEventTypeEXT::e_UNIMPORT_EXT: return "VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_UNIMPORT_EXT";
	case DeviceMemoryReportEventTypeEXT::e_ALLOCATION_FAILED_EXT: return "VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_ALLOCATION_FAILED_EXT";
	default: return "invalid";
	}
}
...
inline std::string to_string(ValidationFeatureEnableEXT value)
{
	...
	case ValidationFeatureEnableEXT::e_SYNCHRONIZATION_VALIDATION_EXT: return "VK_VALIDATION_FEATURE_ENABLE_SYNCHRONIZATION_VALIDATION_EXT";
	default: return "invalid";
	}
}
...
inline std::string to_string(DriverId value)
{
	...
	case DriverId::e_MOLTENVK: return "VK_DRIVER_ID_MOLTENVK";
	default: return "invalid";
	}
}
...
inline std::string to_string(AccelerationStructureTypeKHR value)
{
	...
	case AccelerationStructureTypeKHR::e_GENERIC_KHR: return "VK_ACCELERATION_STRUCTURE_TYPE_GENERIC_KHR";
	default: return "invalid";
	}
}
...
DEFINE_ENUM_BITWISE_OPERATORS(AccelerationStructureCompatibilityKHR)
inline std::string to_string(AccelerationStructureCompatibilityKHR value)
{
	switch(value)
	{
	case AccelerationStructureCompatibilityKHR::e_COMPATIBLE_KHR: return "VK_ACCELERATION_STRUCTURE_COMPATIBILITY_COMPATIBLE_KHR";
	case AccelerationStructureCompatibilityKHR::e_INCOMPATIBLE_KHR: return "VK_ACCELERATION_STRUCTURE_COMPATIBILITY_INCOMPATIBLE_KHR";
	default: return "invalid";
	}
}
...
DEFINE_ENUM_BITWISE_OPERATORS(ShaderGroupShaderKHR)
inline std::string to_string(ShaderGroupShaderKHR value)
{
	switch(value)
	{
	case ShaderGroupShaderKHR::e_GENERAL_KHR: return "VK_SHADER_GROUP_SHADER_GENERAL_KHR";
	case ShaderGroupShaderKHR::e_CLOSEST_HIT_KHR: return "VK_SHADER_GROUP_SHADER_CLOSEST_HIT_KHR";
	case ShaderGroupShaderKHR::e_ANY_HIT_KHR: return "VK_SHADER_GROUP_SHADER_ANY_HIT_KHR";
	case ShaderGroupShaderKHR::e_INTERSECTION_KHR: return "VK_SHADER_GROUP_SHADER_INTERSECTION_KHR";
	default: return "invalid";
	}
}
...
struct BindIndexBufferIndirectCommandNV: private VkBindIndexBufferIndirectCommandNV
{
	...
	BindIndexBufferIndirectCommandNV(DeviceAddress bufferAddress, uint32_t size, IndexType indexType)
	{
		setBufferAddress(bufferAddress);
		setSize(size);
		setIndexType(indexType);
	}
    inline DeviceAddress getBufferAddress() const { return (DeviceAddress)bufferAddress; }
	inline void setBufferAddress(DeviceAddress inBufferAddress) { this->bufferAddress = (VkDeviceAddress)inBufferAddress; }
    inline uint32_t getSize() const { return size; }
	inline void setSize(uint32_t inSize) { this->size = inSize; }
...
struct BindVertexBufferIndirectCommandNV: private VkBindVertexBufferIndirectCommandNV
{
	...
	BindVertexBufferIndirectCommandNV(DeviceAddress bufferAddress, uint32_t size, uint32_t stride)
	{
		setBufferAddress(bufferAddress);
		setSize(size);
		setStride(stride);
...
struct IndirectCommandsStreamNV: private VkIndirectCommandsStreamNV
{
	...
	IndirectCommandsStreamNV(VkBuffer buffer, VkDeviceSize offset)
	{
		setBuffer(buffer);
		setOffset(offset);
	}
...
public:
	...
	DeviceOrHostAddressKHR(DeviceAddress deviceAddress, void* hostAddress)
	{
		setDeviceAddress(deviceAddress);
		setHostAddress(hostAddress);
	}
    inline DeviceAddress getDeviceAddress() const { return (DeviceAddress)_DeviceOrHostAddressKHR.deviceAddress; }
	inline void setDeviceAddress(DeviceAddress inDeviceAddress) { this->_DeviceOrHostAddressKHR.deviceAddress = (VkDeviceAddress)inDeviceAddress; }
    inline const void* getHostAddress() const { return _DeviceOrHostAddressKHR.hostAddress; }
	inline void setHostAddress(void* inHostAddress) { this->_DeviceOrHostAddressKHR.hostAddress = inHostAddress; }
...
public:
	...
	DeviceOrHostAddressConstKHR(DeviceAddress deviceAddress, void* hostAddress)
	{
		setDeviceAddress(deviceAddress);
		setHostAddress(hostAddress);
	}
    inline DeviceAddress getDeviceAddress() const { return (DeviceAddress)_DeviceOrHostAddressConstKHR.deviceAddress; }
	inline void setDeviceAddress(DeviceAddress inDeviceAddress) { this->_DeviceOrHostAddressConstKHR.deviceAddress = (VkDeviceAddress)inDeviceAddress; }
    inline const void* getHostAddress() const { return _DeviceOrHostAddressConstKHR.hostAddress; }
	inline void setHostAddress(void* inHostAddress) { this->_DeviceOrHostAddressConstKHR.hostAddress = inHostAddress; }
...
struct AccelerationStructureBuildRangeInfoKHR: private VkAccelerationStructureBuildRangeInfoKHR
{
	AccelerationStructureBuildRangeInfoKHR()
	{
		setPrimitiveCount(uint32_t());
		setPrimitiveOffset(uint32_t());
		setFirstVertex(uint32_t());
		setTransformOffset(uint32_t());
	}
	AccelerationStructureBuildRangeInfoKHR(const VkAccelerationStructureBuildRangeInfoKHR& vkType): VkAccelerationStructureBuildRangeInfoKHR(vkType){}
	AccelerationStructureBuildRangeInfoKHR(uint32_t primitiveCount, uint32_t primitiveOffset, uint32_t firstVertex, uint32_t transformOffset)
	{
		setPrimitiveCount(primitiveCount);
		setPrimitiveOffset(primitiveOffset);
		setFirstVertex(firstVertex);
		setTransformOffset(transformOffset);
	}
    inline uint32_t getPrimitiveCount() const { return primitiveCount; }
	inline void setPrimitiveCount(uint32_t inPrimitiveCount) { this->primitiveCount = inPrimitiveCount; }
    inline uint32_t getPrimitiveOffset() const { return primitiveOffset; }
	inline void setPrimitiveOffset(uint32_t inPrimitiveOffset) { this->primitiveOffset = inPrimitiveOffset; }
    inline uint32_t getFirstVertex() const { return firstVertex; }
	inline void setFirstVertex(uint32_t inFirstVertex) { this->firstVertex = inFirstVertex; }
    inline uint32_t getTransformOffset() const { return transformOffset; }
	inline void setTransformOffset(uint32_t inTransformOffset) { this->transformOffset = inTransformOffset; }
	inline VkAccelerationStructureBuildRangeInfoKHR& get() { return *this; }
	inline const VkAccelerationStructureBuildRangeInfoKHR& get() const { return *this; }
};
...
struct AccelerationStructureInstanceKHR: private VkAccelerationStructureInstanceKHR
{
	...
	AccelerationStructureInstanceKHR(const TransformMatrixKHR& transform, uint32_t instanceCustomIndex, uint32_t mask, uint32_t instanceShaderBindingTableRecordOffset, GeometryInstanceFlagsKHR flags, uint64_t accelerationStructureReference)
	{
...
public:
	...
	bool extDirectfbSurfaceEnabled = false;

void setEnabledExtension(const std::string& extension)
{
	std::string instanceExtensions[32] = {
		"VK_KHR_surface",
		"VK_KHR_display",
		"VK_KHR_xlib_surface",
		"VK_KHR_xcb_surface",
	...
	bool* instanceExtensionsFlags[32] = {
		&khrSurfaceEnabled,
		&khrDisplayEnabled,
...
public:
	...
	bool khrAccelerationStructureEnabled = false;
	// VK_KHR_ray_tracing_pipeline
	bool khrRayTracingPipelineEnabled = false;
	// VK_KHR_ray_query
	bool khrRayQueryEnabled = false;
	...
	bool khrPortabilitySubsetEnabled = false;
	...
	bool khrShaderTerminateInvocationEnabled = false;
	...
	bool extDeviceMemoryReportEnabled = false;
	// VK_EXT_robustness2
	...
	bool nvFragmentShadingRateEnumsEnabled = false;
	// VK_EXT_fragment_density_map2
	bool extFragmentDensityMap2Enabled = false;
	// VK_QCOM_rotated_copy_commands
	bool qcomRotatedCopyCommandsEnabled = false;
	// VK_EXT_image_robustness
	bool extImageRobustnessEnabled = false;
	// VK_KHR_copy_commands2
	bool khrCopyCommands2Enabled = false;
	// VK_EXT_4444_formats
	bool ext4444FormatsEnabled = false;

void setEnabledExtension(const std::string& extension)
{
	std::string deviceExtensions[189] = {
		"VK_KHR_swapchain",
		"VK_KHR_display_swapchain",
		"VK_NV_glsl_shader",
		"VK_EXT_depth_range_unrestricted",
	...
	bool* deviceExtensionsFlags[189] = {
		&khrSwapchainEnabled,
		...
		&khrAccelerationStructureEnabled,
		&khrRayTracingPipelineEnabled,
		&khrRayQueryEnabled,
		...
		&khrShaderTerminateInvocationEnabled,
		...
		&khrFragmentShadingRateEnabled,
		&amdShaderCoreProperties2Enabled,
		&amdDeviceCoherentMemoryEnabled,
		&extShaderImageAtomicInt64Enabled,
		&khrSpirv14Enabled,
		...
		&extShaderAtomicFloatEnabled,
		&extHostQueryResetEnabled,
		&extIndexTypeUint8Enabled,
		&extExtendedDynamicStateEnabled,
		...
		&nvFragmentShadingRateEnumsEnabled,
		&extFragmentDensityMap2Enabled,
		&qcomRotatedCopyCommandsEnabled,
		&extImageRobustnessEnabled,
		&khrCopyCommands2Enabled,
		&ext4444FormatsEnabled,
	};
