...
public:
	...
	uint64_t getObjectHandle() const
	{
	...
	void setObjectHandle(uint64_t objectHandle)
	{
...
public:
	...
	void setTagName(uint64_t tagName)
	{
	...
	void setTagSize(size_t tagSize)
	{
...
public:
	...
	DebugUtilsMessengerCallbackData(DebugUtilsMessengerCallbackDataFlagsEXT flags, const std::string& messageIdName, int32_t messageIdNumber, const std::string& message,
		...
		: _flags(flags), _messageIdName(messageIdName), _messageIdNumber(messageIdNumber), _message(message), _queueLabels(queueLabels), _cmdBufLabels(cmdBufLabels),
		  _objects(objects)
	{}

	/// <summary>Get the message callback flags</summary>
	/// <returns>The message callback flags</returns>
	DebugUtilsMessengerCallbackDataFlagsEXT getFlags() const
	{
		return _flags;
	}
	...
	void setFlags(DebugUtilsMessengerCallbackDataFlagsEXT flags)
	{
		this->_flags = flags;
	}
	...
	const std::string& getMessageIdName() const
	{
		return _messageIdName;
	}

	/// <summary>Set the id name of the message</summary>
	/// <param name="messageIdName">A new id name for the message</param>
	void setMessageIdName(const std::string& messageIdName)
	{
		this->_messageIdName = messageIdName;
	}

	/// <summary>Get the message id number</summary>
	/// <returns>The id of the message</returns>
	int32_t getMessageIdNumber() const
	{
		return _messageIdNumber;
	}

	/// <summary>Set the id of the message</summary>
	/// <param name="messageIdNumber">A new id for the message</param>
	void setMessageIdName(int32_t messageIdNumber)
	{
		this->_messageIdNumber = messageIdNumber;
	}
	...
	{
		return static_cast<uint32_t>(_queueLabels.size());
	}
	...
	{
		this->_queueLabels.emplace_back(queueLabel);
	}
	...
	{
		return static_cast<uint32_t>(_cmdBufLabels.size());
	}
	...
	{
		this->_cmdBufLabels.emplace_back(cmdBufLabel);
	}
	...
	{
		return static_cast<uint32_t>(_objects.size());
	}
	...
	{
		this->_objects.emplace_back(cmdBufLabel);
	}
...
public:
	...
	DebugUtilsMessengerCreateFlagsEXT getFlags() const
	{
		return _flags;
	}
	...
	DebugUtilsMessageSeverityFlagsEXT getMessageSeverity() const
	{
	...
	DebugUtilsMessageTypeFlagsEXT getMessageType() const
	{
		return _messageType;
	}
