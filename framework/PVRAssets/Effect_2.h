...
struct Effect : public Asset<Effect>
{
	...
	pvr::ContiguousMap<StringHash, pvr::ContiguousMap<StringHash, PipelineDefinition> >
		versionedPipelines; ///< Lists of pipelines, along with their corresponding apis that they apply to
