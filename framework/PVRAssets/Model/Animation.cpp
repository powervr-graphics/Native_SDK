...
glm::mat4x4 Animation::getTransformationMatrix(uint32_t frame, float interp) const
{
	if (_data.matrices.size())
	{
		if (_data.flags & Animation::HasMatrixAnimation)
		{
			...
			return glm::mat4x4(_data.matrices[index + 0], _data.matrices[index + 1], _data.matrices[index + 2], _data.matrices[index + 3], _data.matrices[index + 4],
				_data.matrices[index + 5], _data.matrices[index + 6], _data.matrices[index + 7], _data.matrices[index + 8], _data.matrices[index + 9], _data.matrices[index + 10],
				_data.matrices[index + 11], _data.matrices[index + 12], _data.matrices[index + 13], _data.matrices[index + 14], _data.matrices[index + 15]);
		}
		else if ((_data.flags & Animation::HasPositionAnimation) && (_data.flags & Animation::HasScaleAnimation) && (_data.flags & Animation::HasRotationAnimation))
		{
		...
		{
			return glm::mat4x4(_data.matrices[0], _data.matrices[1], _data.matrices[2], _data.matrices[3], _data.matrices[4], _data.matrices[5], _data.matrices[6], _data.matrices[7],
				_data.matrices[8], _data.matrices[9], _data.matrices[10], _data.matrices[11], _data.matrices[12], _data.matrices[13], _data.matrices[14], _data.matrices[15]);
		}
	}
	else
	{
