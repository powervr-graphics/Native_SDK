...
void TextureReaderDDS::readNextAsset(Texture& asset)
{
	if (_assetStream->getSize() < texture_dds::c_expectedDDSSize)
	{
		throw InvalidDataError("[TextureReaderDDS::readNextAsset]: Asset read had a size less than the DDS size.");
	}
	...
	{
		throw InvalidDataError("[TextureReaderDDS::readNextAsset]: Asset read did not have the correct magic identifier.");
	}
	...
	{
		throw InvalidDataError("[TextureReaderDDS::readNextAsset]: Asset read did not have the correct DDS Header size.");
	}
	...
	{
		throw InvalidDataError("[TextureReaderDDS::readNextAsset]: Asset read did not have a supported Pixel Format.");
	}
