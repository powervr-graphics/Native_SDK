...
private:
	virtual void addAssetToWrite(const Texture& asset);
	bool setDirect3DFormatToDDSHeader(texture_dds::D3DFormat d3dFormat, texture_dds::FileHeader& ddsFileHeader);

	void writeFileHeader(const texture_dds::FileHeader& ddsFileHeader);
	void writeFileHeaderDX10(const texture_dds::FileHeaderDX10& ddsFileHeaderDX10);
};
} // namespace assetWriters
} // namespace assets
} // namespace pvr
