...
*******************************************************************************************************************/
GLenum face(types::Face::Enum face);
...
*******************************************************************************************************************/
GLenum polygonWindingOrder(types::PolygonWindingOrder::Enum windingOrder);
...
*******************************************************************************************************************/
GLenum comparisonMode(types::ComparisonMode::Enum func);
...
*******************************************************************************************************************/
GLenum imageAspect(types::ImageAspect::Enum type);
...
*******************************************************************************************************************/
GLenum fboTextureAttachmentTexType(types::FboTextureTarget::Enum type);
...
*******************************************************************************************************************/
GLenum textureDimension(types::TextureDimension::Enum texType);
...
*******************************************************************************************************************/
GLenum dataType(types::DataType::Enum dataType);
...
*******************************************************************************************************************/
GLenum drawPrimitiveType(types::PrimitiveTopology::Enum primitiveType);
...
*******************************************************************************************************************/
GLenum samplerWrap(types::SamplerWrap::Enum samplerWrap);
...
*******************************************************************************************************************/
GLenum samplerMagFilter(types::SamplerFilter::Enum filter);
...
*******************************************************************************************************************/
GLenum samplerMinFilter(types::SamplerFilter::Enum minFilter, types::SamplerFilter::Enum mipFilter);
...
*******************************************************************************************************************/
GLenum stencilOp(types::StencilOp::Enum stencilOp);
...
*******************************************************************************************************************/
GLenum blendEq(types::BlendOp::Enum blendOp);
...
*******************************************************************************************************************/
GLenum blendFactor(types::BlendFactor::Enum blendFactor);
