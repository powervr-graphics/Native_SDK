...
public:
    ...
    ***********************************************************************************************************************/
	static Result::Enum convertAsciiToUnicode(const char8* asciiString, std::vector<utf8>& unicodeString);
	...
	\return      pvr::Result Success or error code.
    ***********************************************************************************************************************/
	static Result::Enum convertAsciiToUnicode(const char8* asciiString, std::vector<utf16>& unicodeString);
	...
	\return      pvr::Result Success or error code.
    ***********************************************************************************************************************/
	static Result::Enum convertAsciiToUnicode(const char8* asciiString, std::vector<utf32>& utf32StringOut);
	...
	\return      pvr::Result Success or error code.
    ***********************************************************************************************************************/
	static Result::Enum convertUTF8ToUTF16(const utf8* utf8String, std::vector<utf16>& utf16StringOut);
	...
	\return      pvr::Result Success or error code.
    ***********************************************************************************************************************/
	static Result::Enum convertUTF8ToUTF32(const utf8* utf8String, std::vector<utf32>& utf32StringOut);
	...
	\return      pvr::Result Success or error code.
    ***********************************************************************************************************************/
	static Result::Enum convertUTF16ToUTF8(const utf16* utf16String, std::vector<utf8>& utf8StringOut);
	...
	\return      pvr::Result Success or error code.
    ***********************************************************************************************************************/
	static Result::Enum convertUTF16ToUTF32(const utf16* utf16String, std::vector<utf32>& utf32StringOut);
	...
	\return      pvr::Result Success or error code.
    ***********************************************************************************************************************/
	static Result::Enum convertUTF32ToUTF8(const utf32* utf32String, std::vector<utf8>& utf8StringOut);
	...
	\return      pvr::Result Success or error code.
    ***********************************************************************************************************************/
	static Result::Enum convertUTF32ToUTF16(const utf32* utf32String, std::vector<utf16>& utf16StringOut);
