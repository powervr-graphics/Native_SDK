...
template<typename> struct Metadata;

//!\cond NO_DOXYGEN
template<> struct Metadata<char*> { typedef std::array<char, 64> storagetype; static const GpuDatatypes dataTypeOf() { return GpuDatatypes::Float; } static const size_t gpuSizeOf() { return 1; } };
template<> struct Metadata<unsigned char*> { typedef std::array<char, 64> storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::Float; } static size_t gpuSizeOf() { return 1; } };
template<> struct Metadata<const char*> { typedef std::array<char, 64> storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::Float; } static size_t gpuSizeOf() { return 1; } };
template<> struct Metadata<const unsigned char*> { typedef std::array<char, 64> storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::Float; } static size_t gpuSizeOf() { return 1; } };
template<> struct Metadata<double> { typedef float storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::Float; } static size_t gpuSizeOf() { return 8; } };
template<> struct Metadata<float> { typedef float storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::Float; } static size_t gpuSizeOf() { return 4; } };
template<> struct Metadata<int64_t> { typedef int32_t storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::Integer; } static size_t gpuSizeOf() { return 8; } };
template<> struct Metadata<int32_t> { typedef int32_t storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::Integer; } static size_t gpuSizeOf() { return 4; } };
template<> struct Metadata<int16_t> { typedef int32_t storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::Integer; } static size_t gpuSizeOf() { return 2; } };
template<> struct Metadata<int8_t> { typedef int32_t storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::Integer; } static size_t gpuSizeOf() { return 1; } };
template<> struct Metadata<uint64_t> { typedef uint32_t storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::uinteger; } static size_t gpuSizeOf() { return 8; } };
template<> struct Metadata<uint32_t> { typedef uint32_t storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::uinteger; } static size_t gpuSizeOf() { return 4; } };
template<> struct Metadata<uint16_t> { typedef uint32_t storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::uinteger; } static size_t gpuSizeOf() { return 2; } };
template<> struct Metadata<uint8_t> { typedef uint32_t storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::uinteger; } static size_t gpuSizeOf() { return 1; } };
template<> struct Metadata<glm::vec2> { typedef glm::vec2 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::vec2; } static size_t gpuSizeOf() { return 8; } };
template<> struct Metadata<glm::vec3> { typedef glm::vec3 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::vec3; } static size_t gpuSizeOf() { return 12; } };
template<> struct Metadata<glm::vec4> { typedef glm::vec4 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::vec4; } static size_t gpuSizeOf() { return 16; } };
template<> struct Metadata<glm::ivec2> { typedef glm::ivec2 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::ivec2; } static size_t gpuSizeOf() { return 8; } };
template<> struct Metadata<glm::ivec3> { typedef glm::ivec3 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::ivec3; } static size_t gpuSizeOf() { return 12; } };
template<> struct Metadata<glm::ivec4> { typedef glm::ivec4 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::ivec4; } static size_t gpuSizeOf() { return 16; } };
template<> struct Metadata<glm::uvec2> { typedef glm::uvec2 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::uvec2; } static size_t gpuSizeOf() { return 8; } };
template<> struct Metadata<glm::uvec3> { typedef glm::uvec3 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::uvec3; } static size_t gpuSizeOf() { return 12; } };
template<> struct Metadata<glm::uvec4> { typedef glm::uvec4 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::uvec4; } static size_t gpuSizeOf() { return 16; } };
template<> struct Metadata<glm::bvec2> { typedef glm::bvec2 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::bvec2; } static size_t gpuSizeOf() { return 8; } };
template<> struct Metadata<glm::bvec3> { typedef glm::bvec3 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::bvec3; } static size_t gpuSizeOf() { return 12; } };
template<> struct Metadata<glm::bvec4> { typedef glm::bvec4 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::bvec4; } static size_t gpuSizeOf() { return 16; } };
template<> struct Metadata<glm::mat2x2> { typedef glm::mat2x2 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::mat2x2; } static size_t gpuSizeOf() { return 32; } };
template<> struct Metadata<glm::mat2x3> { typedef glm::mat2x3 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::mat2x3; } static size_t gpuSizeOf() { return 32; } };
template<> struct Metadata<glm::mat2x4> { typedef glm::mat2x4 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::mat2x4; } static size_t gpuSizeOf() { return 32; } };
template<> struct Metadata<glm::mat3x2> { typedef glm::mat3x2 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::mat3x2; } static size_t gpuSizeOf() { return 48; } };
template<> struct Metadata<glm::mat3x3> { typedef glm::mat3x3 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::mat3x3; } static size_t gpuSizeOf() { return 48; } };
template<> struct Metadata<glm::mat3x4> { typedef glm::mat3x4 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::mat3x4; } static size_t gpuSizeOf() { return 48; } };
template<> struct Metadata<glm::mat4x2> { typedef glm::mat4x2 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::mat4x2; } static size_t gpuSizeOf() { return 64; } };
template<> struct Metadata<glm::mat4x3> { typedef glm::mat4x3 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::mat4x3; } static size_t gpuSizeOf() { return 64; } };
template<> struct Metadata<glm::mat4x4> { typedef glm::mat4x4 storagetype; static GpuDatatypes dataTypeOf() { return GpuDatatypes::mat4x4; } static size_t gpuSizeOf() { return 64; } };
//!\endcond
}
...
public:
	...
	template<typename Type_> Type_& interpretValueAs(uint32_t entryIndex = 0) { return reinterpret_cast<Type_*>(value_)[entryIndex]; }

	/// <summary>Interpret the value as (an array of) a specified type and retrieve the item at a specific position.</summary>
	/// <typeparam name="Type_">The type as which the value is interpreted</typeparam>
	/// <param name="entryIndex">If an array, which item to retrieve (default 0)</typeparam>
	/// <returns>A value of type <paramRef name="Type_"/> at index <paramRef name="entryIndex"/></returns>
	template<typename Type_> const Type_& interpretValueAs(uint32_t entryIndex = 0) const { return reinterpret_cast<const Type_*>(value_)[entryIndex]; }
};
...
public:
	...
	{
		uint64_t dataTypeSize = (dataType_ == GpuDatatypes::none ?
		                         arrayElements : getCpuPackedSize(dataType_) * arrayElements);
	...
	template<typename Type_> void setValue(const Type_& rawvalue, uint32_t arrayIndex)
	{
		assertion(arrayElements_ > arrayIndex, "TypedMemory:: If array values "
...
public:
	...
	template<typename Type_> Type_& interpretValueAs() { return *reinterpret_cast<Type_*>(chars_); }

	/// <summary>Read the value as if it was of the specified type</summary>
	/// <typeparam name="Type_">Interpret the value as an object of this type and return a reference to it</typeparam>
	/// <returns> A reference to the object, interpreted as of the specified Type</returns>
	template<typename Type_> const Type_& interpretValueAs() const { return *reinterpret_cast<const Type_*>(chars_); }
