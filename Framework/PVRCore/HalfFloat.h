...
public:
	// Constructors
	HalfFloat() {}
	HalfFloat(const HalfFloat& value) : m_value(value.m_value) {}
...
private:
	...
	{
		HalfFloatData halfData = { m_value };
	...
	float unpackFloat() const
	{
		...
		const HalfFloatData halfData = { m_value };
