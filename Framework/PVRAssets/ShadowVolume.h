...
public:
	...
	uint32_t isVisible(const glm::mat4x4 projection, const glm::vec3& lightModel, bool isPointLight, float cameraZProj,
	                   float extrudeLength);
	...
	bool projectSilhouette(uint32_t volumeID, uint32_t flags, const glm::vec3& lightModel, bool isPointLight,
	                       char** externalIndexBuffer = NULL);
...
private:
	...
	bool project(uint32_t volumeID, uint32_t flags, const glm::vec3& lightModel, bool isPointLight,
