...
\file PVRUtils/OGLES/ConvertToGlesTypes.h
...
/// <returns>Returns 'True' if the utility function was able to successfully determin the OpenGL ES formats corresponding to the provided pvr::PixelFormat pixelFormat,
/// pvr::ColorSpace colorSpace and pvr::VariableType dataType.</returns>
bool getOpenGLFormat(PixelFormat pixelFormat, ColorSpace colorSpace, VariableType dataType, uint32_t& glInternalFormat,
                     uint32_t& glFormat, uint32_t& glType, uint32_t& glTypeSize, bool& isCompressedFormat);
...
/// <param name="isCompressedFormat">Specifies whether the OpenGL ES format retrieved is a compressed format.</param>
/// <returns>Returns 'True' if the utility function was able to successfully determin the OpenGL ES formats corresponding to the provided pvr::ImageStorageFormat storageFormat.</returns>
inline bool getOpenGLFormat(ImageStorageFormat storageFormat, uint32_t& glInternalFormat, uint32_t& glFormat, uint32_t& glType,
                            uint32_t& glTypeSize, bool& isCompressedFormat)
{
	return getOpenGLFormat(storageFormat.format, storageFormat.colorSpace, storageFormat.dataType, glInternalFormat, glFormat, glType, glTypeSize, isCompressedFormat);
}
...
/// <returns>Returns 'True' if the utility function was able to successfully determin the OpenGL ES formats corresponding to the provided pvr::PixelFormat pixelFormat,
/// pvr::ColorSpace colorSpace and pvr::VariableType dataType.</returns>
bool getOpenGLStorageFormat(PixelFormat pixelFormat, ColorSpace colorSpace, VariableType dataType, GLenum& glInternalFormat);
...
/// <param name="glInternalFormat">The internal OpenGL ES format corresponding to the provided pvr::ImageStorageFormat storageFormat</param>
/// <returns>Returns 'True' if the utility function was able to successfully determin the internal OpenGL ES format corresponding to the provided pvr::ImageStorageFormat storageFormat.</returns>
inline bool getOpenGLStorageFormat(ImageStorageFormat storageFormat, GLenum& glInternalFormat)
{
	return getOpenGLStorageFormat(storageFormat.format, storageFormat.colorSpace, storageFormat.dataType, glInternalFormat);
}
