...
For PVRUtilsVk, UIRenderer will use a Command Buffer provided to it to queue up the "recipe" for a render, allowing the user to defer it for later for using it inside complex engines.
For PVRUtilsGles, UIRenderer will execute the rendering commands immediately at the point of calling "render".

Other utilities include 
<ul>
<li>A ton of helpers like instance/devices/swapchain creation for Vulkan and EGLContexts for OGLES, eliminating the overhead of configuring everything every time</li>
...
<li>
<ol>
<li>A project dependency (windows/osx/ios/android/...) (project file in <span class="code">Framework/PVRUtils/[Vulkan/OGLES]/Build/[Platform]/...</span>)</li>
