...
<ul>
	<li>Depending on the platform, add the module in by adding either:<br/>
		<ul>
			<li>A project dependency (windows/osx/ios/android/...) (project file in <span class="code">Framework/PVRShell/Build/[Platform]/...</span>)</li>
			<li>The library to link against directly (windows/android/linux makefiles) (.so etc. in <span class="code">Framework/Bin/[Platform]/[lib?]PVRShell[.lib/.so]</span>)</li>
		</ul>
	</li>
...
<p>Override either <span class="code">pvr::Shell::eventMappedInput(…)</span> and/or any of the device-specific input functions (<span class="code">pvr::Shell::onKeyDown</span>, <span class="code">onKeyUp</span>, <span class="code">onPointingDeviceDown</span>, etc.).</p>
...
switch (evt){case MappedInputEvent::Action1: pauseDemo();break;	case MappedInputEvent::Left: showPreviousPage(); break;	case MappedInputEvent::Quit: if (showExitDialogue()) exitShell(); break;}}
\endcode
