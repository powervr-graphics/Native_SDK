/*!
\brief Contains the implementation for the pvr::platform::ShellOS class on Null Windowing System platforms (Neutrino).
\file PVRShell\OS/NeutrinoNullWS/ShellOS.cpp
