/*!*********************************************************************************************************************
\file         PVRUIRenderer\PVRUIRenderer.h
\author       PowerVR by Imagination, Developer Technology Team
\copyright    Copyright (c) Imagination Technologies Limited.
\brief         Include this file if you wish to use the PVRUIRenderer functionality.
***********************************************************************************************************************/

#pragma once
#include "PVRUIRenderer/UIRenderer.h"
/*****************************************************************************/
/*! \mainpage PVRUIRenderer
******************************************************************************
...
PVRUIRenderer leverages PVRApi to provide a simple, platform- and API-agnostic library for rendering 2D elements in a 3D environment. Specifically, PVRUIRenderer was written with text and sprites in mind.

A wealth of tools is provided to import fonts and create glyphs for specific or full parts of them. In most circumstances, PVRUIRenderer will use a Command Buffer provided to it to queue up the "recipe" for a render, allowing the user to defer it for later using inside complex engines.

PVRUIRenderer source can be found in the <a href="../../">PVRUIRenderer</a> folder in the SDK package.
...
<li>
<ol>
<li>A project dependency (windows/osx/ios/android/...) (project file in <span class="code">Framework/PVRUIRenderer/Build/[Platform]/...</span>)</li>
<li>The library to link against directly (windows/android/linux makefiles) (.so etc. in <span class="code">Framework/Bin/[Platform]/[lib?]PVRUIRenderer[.lib/.so]</span>)</li>
</ol>
</li>
<li>Also link against the PowerVR Framework dependencies of PVRUIRenderer: (PVRApi and its dependencies(PVRCore, PVRAssets, PVRPlatformGlue, PVRShell))</li>
<li>Include the PVRUIRenderer header file (<span class="code">PVRUIRenderer/PVRUIRenderer.h</span>)</li>
</ol>
</li>
