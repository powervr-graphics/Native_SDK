/*!*********************************************************************************************************************
\file         PVRPlatformGLue\EGL\ExtensionLoaderEgl.h
\author       PowerVR by Imagination, Developer Technology Team
\copyright    Copyright (c) Imagination Technologies Limited.
\brief         Include this file if you want to directly use EGL extensions in your code. eglext class is populated automatically.
***********************************************************************************************************************/
#pragma once
#include "PVRPlatformGlue/EGL/ApiEgl.h"
#include "PVRPlatformGlue/EGL/NativeLibraryEgl.h"

/*!*********************************************************************************************************************
\brief      This class contains function pointers for all EGL extensions that existed at the time of publishing. Can be updated
           as required. The function pointers get automatically populated on application start during State Machine creation.
		   (function pvr::createNativePlatformContext). Use as a namespace (e.g. eglext::WaitSyncKHR).
***********************************************************************************************************************/
class eglext
{
public:
...
namespace native {
/*!*********************************************************************************************************************
\brief         EglExtensions class can be used to facilitate loading and using EGL extensions
***********************************************************************************************************************/
class EglExtensions
{
public:
