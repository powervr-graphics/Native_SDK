 ...
 ******************************
 ...
 It is used to initialise variables that are not dependent on the rendering context (e.g. external modules, loading user data, etc.).
 ...
 It is used to initialise variables that are dependent on the rendering context (e.g. textures, vertex buffers, etc.).
...
enum prefNameIntEnum
{
	...
	prefEGLMinorVersion,    /*!< EGL: returns the major version as returned by eglInitialize() */
	prefApiMajorVersion,    /*!< EGL: returns the OpenGL major version required */
	prefApiMinorVersion,    /*!< EGL: returns the OpenGL minor version required */
