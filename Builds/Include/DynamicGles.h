...
// DYNAMICGLES_FUNCTION AN ERROR LOGGING FUNCTION
...
// WRAP THE LIBRARY LOADING FUNCTION TO LOG ITS ERRORS
namespace gl {
namespace internals {
inline void* GetLibFunctionChecked(LIBTYPE hLib, const char* name)
{
	...
	if (!func)
	{
		Log_Error("Failed to load function [%s] from OpenGL ES library.\n", name);
	}
	return func;
}
}
...
inline void* getEs31Function(::gl::internals::Gl31FuncName::OpenGLES31FunctionName funcname)
{
	...
	if (!FunctionTable[0])
	{
		LIBTYPE lib = OpenLibrary(libName);
		if (!lib)
		{
		...
		FunctionTable[Gl31FuncName::DispatchCompute] = GetLibFunctionChecked(lib, "glDispatchCompute");
		FunctionTable[Gl31FuncName::DispatchComputeIndirect] = GetLibFunctionChecked(lib, "glDispatchComputeIndirect");
		FunctionTable[Gl31FuncName::DrawArraysIndirect] = GetLibFunctionChecked(lib, "glDrawArraysIndirect");
		FunctionTable[Gl31FuncName::DrawElementsIndirect] = GetLibFunctionChecked(lib, "glDrawElementsIndirect");
		FunctionTable[Gl31FuncName::FramebufferParameteri] = GetLibFunctionChecked(lib, "glFramebufferParameteri");
		FunctionTable[Gl31FuncName::GetFramebufferParameteriv] = GetLibFunctionChecked(lib, "glGetFramebufferParameteriv");
		FunctionTable[Gl31FuncName::GetProgramInterfaceiv] = GetLibFunctionChecked(lib, "glGetProgramInterfaceiv");
		FunctionTable[Gl31FuncName::GetProgramResourceIndex] = GetLibFunctionChecked(lib, "glGetProgramResourceIndex");
		FunctionTable[Gl31FuncName::GetProgramResourceName] = GetLibFunctionChecked(lib, "glGetProgramResourceName");
		FunctionTable[Gl31FuncName::GetProgramResourceiv] = GetLibFunctionChecked(lib, "glGetProgramResourceiv");
		FunctionTable[Gl31FuncName::GetProgramResourceLocation] = GetLibFunctionChecked(lib, "glGetProgramResourceLocation");
		FunctionTable[Gl31FuncName::UseProgramStages] = GetLibFunctionChecked(lib, "glUseProgramStages");
		FunctionTable[Gl31FuncName::ActiveShaderProgram] = GetLibFunctionChecked(lib, "glActiveShaderProgram");
		FunctionTable[Gl31FuncName::CreateShaderProgramv] = GetLibFunctionChecked(lib, "glCreateShaderProgramv");
		FunctionTable[Gl31FuncName::BindProgramPipeline] = GetLibFunctionChecked(lib, "glBindProgramPipeline");
		FunctionTable[Gl31FuncName::DeleteProgramPipelines] = GetLibFunctionChecked(lib, "glDeleteProgramPipelines");
		FunctionTable[Gl31FuncName::GenProgramPipelines] = GetLibFunctionChecked(lib, "glGenProgramPipelines");
		FunctionTable[Gl31FuncName::IsProgramPipeline] = GetLibFunctionChecked(lib, "glIsProgramPipeline");
		FunctionTable[Gl31FuncName::GetProgramPipelineiv] = GetLibFunctionChecked(lib, "glGetProgramPipelineiv");
		FunctionTable[Gl31FuncName::ProgramUniform1i] = GetLibFunctionChecked(lib, "glProgramUniform1i");
		FunctionTable[Gl31FuncName::ProgramUniform2i] = GetLibFunctionChecked(lib, "glProgramUniform2i");
		FunctionTable[Gl31FuncName::ProgramUniform3i] = GetLibFunctionChecked(lib, "glProgramUniform3i");
		FunctionTable[Gl31FuncName::ProgramUniform4i] = GetLibFunctionChecked(lib, "glProgramUniform4i");
		FunctionTable[Gl31FuncName::ProgramUniform1ui] = GetLibFunctionChecked(lib, "glProgramUniform1ui");
		FunctionTable[Gl31FuncName::ProgramUniform2ui] = GetLibFunctionChecked(lib, "glProgramUniform2ui");
		FunctionTable[Gl31FuncName::ProgramUniform3ui] = GetLibFunctionChecked(lib, "glProgramUniform3ui");
		FunctionTable[Gl31FuncName::ProgramUniform4ui] = GetLibFunctionChecked(lib, "glProgramUniform4ui");
		FunctionTable[Gl31FuncName::ProgramUniform1f] = GetLibFunctionChecked(lib, "glProgramUniform1f");
		FunctionTable[Gl31FuncName::ProgramUniform2f] = GetLibFunctionChecked(lib, "glProgramUniform2f");
		FunctionTable[Gl31FuncName::ProgramUniform3f] = GetLibFunctionChecked(lib, "glProgramUniform3f");
		FunctionTable[Gl31FuncName::ProgramUniform4f] = GetLibFunctionChecked(lib, "glProgramUniform4f");
		FunctionTable[Gl31FuncName::ProgramUniform1iv] = GetLibFunctionChecked(lib, "glProgramUniform1iv");
		FunctionTable[Gl31FuncName::ProgramUniform2iv] = GetLibFunctionChecked(lib, "glProgramUniform2iv");
		FunctionTable[Gl31FuncName::ProgramUniform3iv] = GetLibFunctionChecked(lib, "glProgramUniform3iv");
		FunctionTable[Gl31FuncName::ProgramUniform4iv] = GetLibFunctionChecked(lib, "glProgramUniform4iv");
		FunctionTable[Gl31FuncName::ProgramUniform1uiv] = GetLibFunctionChecked(lib, "glProgramUniform1uiv");
		FunctionTable[Gl31FuncName::ProgramUniform2uiv] = GetLibFunctionChecked(lib, "glProgramUniform2uiv");
		FunctionTable[Gl31FuncName::ProgramUniform3uiv] = GetLibFunctionChecked(lib, "glProgramUniform3uiv");
		FunctionTable[Gl31FuncName::ProgramUniform4uiv] = GetLibFunctionChecked(lib, "glProgramUniform4uiv");
		FunctionTable[Gl31FuncName::ProgramUniform1fv] = GetLibFunctionChecked(lib, "glProgramUniform1fv");
		FunctionTable[Gl31FuncName::ProgramUniform2fv] = GetLibFunctionChecked(lib, "glProgramUniform2fv");
		FunctionTable[Gl31FuncName::ProgramUniform3fv] = GetLibFunctionChecked(lib, "glProgramUniform3fv");
		FunctionTable[Gl31FuncName::ProgramUniform4fv] = GetLibFunctionChecked(lib, "glProgramUniform4fv");
		FunctionTable[Gl31FuncName::ProgramUniformMatrix2fv] = GetLibFunctionChecked(lib, "glProgramUniformMatrix2fv");
		FunctionTable[Gl31FuncName::ProgramUniformMatrix3fv] = GetLibFunctionChecked(lib, "glProgramUniformMatrix3fv");
		FunctionTable[Gl31FuncName::ProgramUniformMatrix4fv] = GetLibFunctionChecked(lib, "glProgramUniformMatrix4fv");
		FunctionTable[Gl31FuncName::ProgramUniformMatrix2x3fv] = GetLibFunctionChecked(lib, "glProgramUniformMatrix2x3fv");
		FunctionTable[Gl31FuncName::ProgramUniformMatrix3x2fv] = GetLibFunctionChecked(lib, "glProgramUniformMatrix3x2fv");
		FunctionTable[Gl31FuncName::ProgramUniformMatrix2x4fv] = GetLibFunctionChecked(lib, "glProgramUniformMatrix2x4fv");
		FunctionTable[Gl31FuncName::ProgramUniformMatrix4x2fv] = GetLibFunctionChecked(lib, "glProgramUniformMatrix4x2fv");
		FunctionTable[Gl31FuncName::ProgramUniformMatrix3x4fv] = GetLibFunctionChecked(lib, "glProgramUniformMatrix3x4fv");
		FunctionTable[Gl31FuncName::ProgramUniformMatrix4x3fv] = GetLibFunctionChecked(lib, "glProgramUniformMatrix4x3fv");
		FunctionTable[Gl31FuncName::ValidateProgramPipeline] = GetLibFunctionChecked(lib, "glValidateProgramPipeline");
		FunctionTable[Gl31FuncName::GetProgramPipelineInfoLog] = GetLibFunctionChecked(lib, "glGetProgramPipelineInfoLog");
		FunctionTable[Gl31FuncName::BindImageTexture] = GetLibFunctionChecked(lib, "glBindImageTexture");
		FunctionTable[Gl31FuncName::GetBooleani_v] = GetLibFunctionChecked(lib, "glGetBooleani_v");
		FunctionTable[Gl31FuncName::MemoryBarrier] = GetLibFunctionChecked(lib, "glMemoryBarrier");
		FunctionTable[Gl31FuncName::MemoryBarrierByRegion] = GetLibFunctionChecked(lib, "glMemoryBarrierByRegion");
		FunctionTable[Gl31FuncName::TexStorage2DMultisample] = GetLibFunctionChecked(lib, "glTexStorage2DMultisample");
		FunctionTable[Gl31FuncName::GetMultisamplefv] = GetLibFunctionChecked(lib, "glGetMultisamplefv");
		FunctionTable[Gl31FuncName::SampleMaski] = GetLibFunctionChecked(lib, "glSampleMaski");
		FunctionTable[Gl31FuncName::GetTexLevelParameteriv] = GetLibFunctionChecked(lib, "glGetTexLevelParameteriv");
		FunctionTable[Gl31FuncName::GetTexLevelParameterfv] = GetLibFunctionChecked(lib, "glGetTexLevelParameterfv");
		FunctionTable[Gl31FuncName::BindVertexBuffer] = GetLibFunctionChecked(lib, "glBindVertexBuffer");
		FunctionTable[Gl31FuncName::VertexAttribFormat] = GetLibFunctionChecked(lib, "glVertexAttribFormat");
		FunctionTable[Gl31FuncName::VertexAttribIFormat] = GetLibFunctionChecked(lib, "glVertexAttribIFormat");
		FunctionTable[Gl31FuncName::VertexAttribBinding] = GetLibFunctionChecked(lib, "glVertexAttribBinding");
		FunctionTable[Gl31FuncName::VertexBindingDivisor] = GetLibFunctionChecked(lib, "glVertexBindingDivisor");
	}
#endif
...
inline void* getEs3Function(::gl::internals::Gl3FuncName::OpenGLES3FunctionName funcname)
{
	...
	{
#if !TARGET_OS_IPHONE
		internals::LIBTYPE lib = OpenLibrary(::gl::internals::libName);
		if (!lib)
		{
			Log_Error("OpenGL ES Bindings: Failed to open library %s\n", internals::libName);
		}
		...
		FunctionTable[Gl3FuncName::ReadBuffer] = GetLibFunctionChecked(lib, "glReadBuffer");
		FunctionTable[Gl3FuncName::DrawRangeElements] = GetLibFunctionChecked(lib, "glDrawRangeElements");
		FunctionTable[Gl3FuncName::TexImage3D] = GetLibFunctionChecked(lib, "glTexImage3D");
		FunctionTable[Gl3FuncName::TexSubImage3D] = GetLibFunctionChecked(lib, "glTexSubImage3D");
		FunctionTable[Gl3FuncName::CopyTexSubImage3D] = GetLibFunctionChecked(lib, "glCopyTexSubImage3D");
		FunctionTable[Gl3FuncName::CompressedTexImage3D] = GetLibFunctionChecked(lib, "glCompressedTexImage3D");
		FunctionTable[Gl3FuncName::CompressedTexSubImage3D] = GetLibFunctionChecked(lib, "glCompressedTexSubImage3D");
		FunctionTable[Gl3FuncName::GenQueries] = GetLibFunctionChecked(lib, "glGenQueries");
		FunctionTable[Gl3FuncName::DeleteQueries] = GetLibFunctionChecked(lib, "glDeleteQueries");
		FunctionTable[Gl3FuncName::IsQuery] = GetLibFunctionChecked(lib, "glIsQuery");
		FunctionTable[Gl3FuncName::BeginQuery] = GetLibFunctionChecked(lib, "glBeginQuery");
		FunctionTable[Gl3FuncName::EndQuery] = GetLibFunctionChecked(lib, "glEndQuery");
		FunctionTable[Gl3FuncName::GetQueryiv] = GetLibFunctionChecked(lib, "glGetQueryiv");
		FunctionTable[Gl3FuncName::GetQueryObjectuiv] = GetLibFunctionChecked(lib, "glGetQueryObjectuiv");
		FunctionTable[Gl3FuncName::UnmapBuffer] = GetLibFunctionChecked(lib, "glUnmapBuffer");
		FunctionTable[Gl3FuncName::GetBufferPointerv] = GetLibFunctionChecked(lib, "glGetBufferPointerv");
		FunctionTable[Gl3FuncName::DrawBuffers] = GetLibFunctionChecked(lib, "glDrawBuffers");
		FunctionTable[Gl3FuncName::UniformMatrix2x3fv] = GetLibFunctionChecked(lib, "glUniformMatrix2x3fv");
		FunctionTable[Gl3FuncName::UniformMatrix3x2fv] = GetLibFunctionChecked(lib, "glUniformMatrix3x2fv");
		FunctionTable[Gl3FuncName::UniformMatrix2x4fv] = GetLibFunctionChecked(lib, "glUniformMatrix2x4fv");
		FunctionTable[Gl3FuncName::UniformMatrix4x2fv] = GetLibFunctionChecked(lib, "glUniformMatrix4x2fv");
		FunctionTable[Gl3FuncName::UniformMatrix3x4fv] = GetLibFunctionChecked(lib, "glUniformMatrix3x4fv");
		FunctionTable[Gl3FuncName::UniformMatrix4x3fv] = GetLibFunctionChecked(lib, "glUniformMatrix4x3fv");
		FunctionTable[Gl3FuncName::BlitFramebuffer] = GetLibFunctionChecked(lib, "glBlitFramebuffer");
		FunctionTable[Gl3FuncName::RenderbufferStorageMultisample] = GetLibFunctionChecked(lib, "glRenderbufferStorageMultisample");
		FunctionTable[Gl3FuncName::FramebufferTextureLayer] = GetLibFunctionChecked(lib, "glFramebufferTextureLayer");
		FunctionTable[Gl3FuncName::MapBufferRange] = GetLibFunctionChecked(lib, "glMapBufferRange");
		FunctionTable[Gl3FuncName::FlushMappedBufferRange] = GetLibFunctionChecked(lib, "glFlushMappedBufferRange");
		FunctionTable[Gl3FuncName::BindVertexArray] = GetLibFunctionChecked(lib, "glBindVertexArray");
		FunctionTable[Gl3FuncName::DeleteVertexArrays] = GetLibFunctionChecked(lib, "glDeleteVertexArrays");
		FunctionTable[Gl3FuncName::GenVertexArrays] = GetLibFunctionChecked(lib, "glGenVertexArrays");
		FunctionTable[Gl3FuncName::IsVertexArray] = GetLibFunctionChecked(lib, "glIsVertexArray");
		FunctionTable[Gl3FuncName::GetIntegeri_v] = GetLibFunctionChecked(lib, "glGetIntegeri_v");
		FunctionTable[Gl3FuncName::BeginTransformFeedback] = GetLibFunctionChecked(lib, "glBeginTransformFeedback");
		FunctionTable[Gl3FuncName::EndTransformFeedback] = GetLibFunctionChecked(lib, "glEndTransformFeedback");
		FunctionTable[Gl3FuncName::BindBufferRange] = GetLibFunctionChecked(lib, "glBindBufferRange");
		FunctionTable[Gl3FuncName::BindBufferBase] = GetLibFunctionChecked(lib, "glBindBufferBase");
		FunctionTable[Gl3FuncName::TransformFeedbackVaryings] = GetLibFunctionChecked(lib, "glTransformFeedbackVaryings");
		FunctionTable[Gl3FuncName::GetTransformFeedbackVarying] = GetLibFunctionChecked(lib, "glGetTransformFeedbackVarying");
		FunctionTable[Gl3FuncName::VertexAttribIPointer] = GetLibFunctionChecked(lib, "glVertexAttribIPointer");
		FunctionTable[Gl3FuncName::GetVertexAttribIiv] = GetLibFunctionChecked(lib, "glGetVertexAttribIiv");
		FunctionTable[Gl3FuncName::GetVertexAttribIuiv] = GetLibFunctionChecked(lib, "glGetVertexAttribIuiv");
		FunctionTable[Gl3FuncName::VertexAttribI4i] = GetLibFunctionChecked(lib, "glVertexAttribI4i");
		FunctionTable[Gl3FuncName::VertexAttribI4ui] = GetLibFunctionChecked(lib, "glVertexAttribI4ui");
		FunctionTable[Gl3FuncName::VertexAttribI4iv] = GetLibFunctionChecked(lib, "glVertexAttribI4iv");
		FunctionTable[Gl3FuncName::VertexAttribI4uiv] = GetLibFunctionChecked(lib, "glVertexAttribI4uiv");
		FunctionTable[Gl3FuncName::GetUniformuiv] = GetLibFunctionChecked(lib, "glGetUniformuiv");
		FunctionTable[Gl3FuncName::GetFragDataLocation] = GetLibFunctionChecked(lib, "glGetFragDataLocation");
		FunctionTable[Gl3FuncName::Uniform1ui] = GetLibFunctionChecked(lib, "glUniform1ui");
		FunctionTable[Gl3FuncName::Uniform2ui] = GetLibFunctionChecked(lib, "glUniform2ui");
		FunctionTable[Gl3FuncName::Uniform3ui] = GetLibFunctionChecked(lib, "glUniform3ui");
		FunctionTable[Gl3FuncName::Uniform4ui] = GetLibFunctionChecked(lib, "glUniform4ui");
		FunctionTable[Gl3FuncName::Uniform1uiv] = GetLibFunctionChecked(lib, "glUniform1uiv");
		FunctionTable[Gl3FuncName::Uniform2uiv] = GetLibFunctionChecked(lib, "glUniform2uiv");
		FunctionTable[Gl3FuncName::Uniform3uiv] = GetLibFunctionChecked(lib, "glUniform3uiv");
		FunctionTable[Gl3FuncName::Uniform4uiv] = GetLibFunctionChecked(lib, "glUniform4uiv");
		FunctionTable[Gl3FuncName::ClearBufferiv] = GetLibFunctionChecked(lib, "glClearBufferiv");
		FunctionTable[Gl3FuncName::ClearBufferuiv] = GetLibFunctionChecked(lib, "glClearBufferuiv");
		FunctionTable[Gl3FuncName::ClearBufferfv] = GetLibFunctionChecked(lib, "glClearBufferfv");
		FunctionTable[Gl3FuncName::ClearBufferfi] = GetLibFunctionChecked(lib, "glClearBufferfi");
		FunctionTable[Gl3FuncName::GetStringi] = GetLibFunctionChecked(lib, "glGetStringi");
		FunctionTable[Gl3FuncName::CopyBufferSubData] = GetLibFunctionChecked(lib, "glCopyBufferSubData");
		FunctionTable[Gl3FuncName::GetUniformIndices] = GetLibFunctionChecked(lib, "glGetUniformIndices");
		FunctionTable[Gl3FuncName::GetActiveUniformsiv] = GetLibFunctionChecked(lib, "glGetActiveUniformsiv");
		FunctionTable[Gl3FuncName::GetUniformBlockIndex] = GetLibFunctionChecked(lib, "glGetUniformBlockIndex");
		FunctionTable[Gl3FuncName::GetActiveUniformBlockiv] = GetLibFunctionChecked(lib, "glGetActiveUniformBlockiv");
		FunctionTable[Gl3FuncName::GetActiveUniformBlockName] = GetLibFunctionChecked(lib, "glGetActiveUniformBlockName");
		FunctionTable[Gl3FuncName::UniformBlockBinding] = GetLibFunctionChecked(lib, "glUniformBlockBinding");
		FunctionTable[Gl3FuncName::DrawArraysInstanced] = GetLibFunctionChecked(lib, "glDrawArraysInstanced");
		FunctionTable[Gl3FuncName::DrawElementsInstanced] = GetLibFunctionChecked(lib, "glDrawElementsInstanced");
		FunctionTable[Gl3FuncName::FenceSync] = GetLibFunctionChecked(lib, "glFenceSync");
		FunctionTable[Gl3FuncName::IsSync] = GetLibFunctionChecked(lib, "glIsSync");
		FunctionTable[Gl3FuncName::DeleteSync] = GetLibFunctionChecked(lib, "glDeleteSync");
		FunctionTable[Gl3FuncName::ClientWaitSync] = GetLibFunctionChecked(lib, "glClientWaitSync");
		FunctionTable[Gl3FuncName::WaitSync] = GetLibFunctionChecked(lib, "glWaitSync");
		FunctionTable[Gl3FuncName::GetInteger64v] = GetLibFunctionChecked(lib, "glGetInteger64v");
		FunctionTable[Gl3FuncName::GetSynciv] = GetLibFunctionChecked(lib, "glGetSynciv");
		FunctionTable[Gl3FuncName::GetInteger64i_v] = GetLibFunctionChecked(lib, "glGetInteger64i_v");
		FunctionTable[Gl3FuncName::GetBufferParameteri64v] = GetLibFunctionChecked(lib, "glGetBufferParameteri64v");
		FunctionTable[Gl3FuncName::GenSamplers] = GetLibFunctionChecked(lib, "glGenSamplers");
		FunctionTable[Gl3FuncName::DeleteSamplers] = GetLibFunctionChecked(lib, "glDeleteSamplers");
		FunctionTable[Gl3FuncName::IsSampler] = GetLibFunctionChecked(lib, "glIsSampler");
		FunctionTable[Gl3FuncName::BindSampler] = GetLibFunctionChecked(lib, "glBindSampler");
		FunctionTable[Gl3FuncName::SamplerParameteri] = GetLibFunctionChecked(lib, "glSamplerParameteri");
		FunctionTable[Gl3FuncName::SamplerParameteriv] = GetLibFunctionChecked(lib, "glSamplerParameteriv");
		FunctionTable[Gl3FuncName::SamplerParameterf] = GetLibFunctionChecked(lib, "glSamplerParameterf");
		FunctionTable[Gl3FuncName::SamplerParameterfv] = GetLibFunctionChecked(lib, "glSamplerParameterfv");
		FunctionTable[Gl3FuncName::GetSamplerParameteriv] = GetLibFunctionChecked(lib, "glGetSamplerParameteriv");
		FunctionTable[Gl3FuncName::GetSamplerParameterfv] = GetLibFunctionChecked(lib, "glGetSamplerParameterfv");
		FunctionTable[Gl3FuncName::VertexAttribDivisor] = GetLibFunctionChecked(lib, "glVertexAttribDivisor");
		FunctionTable[Gl3FuncName::BindTransformFeedback] = GetLibFunctionChecked(lib, "glBindTransformFeedback");
		FunctionTable[Gl3FuncName::DeleteTransformFeedbacks] = GetLibFunctionChecked(lib, "glDeleteTransformFeedbacks");
		FunctionTable[Gl3FuncName::GenTransformFeedbacks] = GetLibFunctionChecked(lib, "glGenTransformFeedbacks");
		FunctionTable[Gl3FuncName::IsTransformFeedback] = GetLibFunctionChecked(lib, "glIsTransformFeedback");
		FunctionTable[Gl3FuncName::PauseTransformFeedback] = GetLibFunctionChecked(lib, "glPauseTransformFeedback");
		FunctionTable[Gl3FuncName::ResumeTransformFeedback] = GetLibFunctionChecked(lib, "glResumeTransformFeedback");
		FunctionTable[Gl3FuncName::GetProgramBinary] = GetLibFunctionChecked(lib, "glGetProgramBinary");
		FunctionTable[Gl3FuncName::ProgramBinary] = GetLibFunctionChecked(lib, "glProgramBinary");
		FunctionTable[Gl3FuncName::ProgramParameteri] = GetLibFunctionChecked(lib, "glProgramParameteri");
		FunctionTable[Gl3FuncName::InvalidateFramebuffer] = GetLibFunctionChecked(lib, "glInvalidateFramebuffer");
		FunctionTable[Gl3FuncName::InvalidateSubFramebuffer] = GetLibFunctionChecked(lib, "glInvalidateSubFramebuffer");
		FunctionTable[Gl3FuncName::TexStorage2D] = GetLibFunctionChecked(lib, "glTexStorage2D");
		FunctionTable[Gl3FuncName::TexStorage3D] = GetLibFunctionChecked(lib, "glTexStorage3D");
		FunctionTable[Gl3FuncName::GetInternalformativ] = GetLibFunctionChecked(lib, "glGetInternalformativ");
#else
...
inline void* getEs2Function(::gl::internals::Gl2FuncName::OpenGLES2FunctionName funcname)
{
	...
	if (!FunctionTable[0])
	{
		...
		FunctionTable[Gl2FuncName::ActiveTexture] = GetLibFunctionChecked(lib, "glActiveTexture");
		FunctionTable[Gl2FuncName::AttachShader] = GetLibFunctionChecked(lib, "glAttachShader");
		FunctionTable[Gl2FuncName::BindAttribLocation] = GetLibFunctionChecked(lib, "glBindAttribLocation");
		FunctionTable[Gl2FuncName::BindBuffer] = GetLibFunctionChecked(lib, "glBindBuffer");
		FunctionTable[Gl2FuncName::BindFramebuffer] = GetLibFunctionChecked(lib, "glBindFramebuffer");
		FunctionTable[Gl2FuncName::BindRenderbuffer] = GetLibFunctionChecked(lib, "glBindRenderbuffer");
		FunctionTable[Gl2FuncName::BindTexture] = GetLibFunctionChecked(lib, "glBindTexture");
		FunctionTable[Gl2FuncName::BlendColor] = GetLibFunctionChecked(lib, "glBlendColor");
		FunctionTable[Gl2FuncName::BlendEquation] = GetLibFunctionChecked(lib, "glBlendEquation");
		FunctionTable[Gl2FuncName::BlendEquationSeparate] = GetLibFunctionChecked(lib, "glBlendEquationSeparate");
		FunctionTable[Gl2FuncName::BlendFunc] = GetLibFunctionChecked(lib, "glBlendFunc");
		FunctionTable[Gl2FuncName::BlendFuncSeparate] = GetLibFunctionChecked(lib, "glBlendFuncSeparate");
		FunctionTable[Gl2FuncName::BufferData] = GetLibFunctionChecked(lib, "glBufferData");
		FunctionTable[Gl2FuncName::BufferSubData] = GetLibFunctionChecked(lib, "glBufferSubData");
		FunctionTable[Gl2FuncName::CheckFramebufferStatus] = GetLibFunctionChecked(lib, "glCheckFramebufferStatus");
		FunctionTable[Gl2FuncName::Clear] = GetLibFunctionChecked(lib, "glClear");
		FunctionTable[Gl2FuncName::ClearColor] = GetLibFunctionChecked(lib, "glClearColor");
		FunctionTable[Gl2FuncName::ClearDepthf] = GetLibFunctionChecked(lib, "glClearDepthf");
		FunctionTable[Gl2FuncName::ClearStencil] = GetLibFunctionChecked(lib, "glClearStencil");
		FunctionTable[Gl2FuncName::ColorMask] = GetLibFunctionChecked(lib, "glColorMask");
		FunctionTable[Gl2FuncName::CompileShader] = GetLibFunctionChecked(lib, "glCompileShader");
		FunctionTable[Gl2FuncName::CompressedTexImage2D] = GetLibFunctionChecked(lib, "glCompressedTexImage2D");
		FunctionTable[Gl2FuncName::CompressedTexSubImage2D] = GetLibFunctionChecked(lib, "glCompressedTexSubImage2D");
		FunctionTable[Gl2FuncName::CopyTexImage2D] = GetLibFunctionChecked(lib, "glCopyTexImage2D");
		FunctionTable[Gl2FuncName::CopyTexSubImage2D] = GetLibFunctionChecked(lib, "glCopyTexSubImage2D");
		FunctionTable[Gl2FuncName::CreateProgram] = GetLibFunctionChecked(lib, "glCreateProgram");
		FunctionTable[Gl2FuncName::CreateShader] = GetLibFunctionChecked(lib, "glCreateShader");
		FunctionTable[Gl2FuncName::CullFace] = GetLibFunctionChecked(lib, "glCullFace");
		FunctionTable[Gl2FuncName::DeleteBuffers] = GetLibFunctionChecked(lib, "glDeleteBuffers");
		FunctionTable[Gl2FuncName::DeleteFramebuffers] = GetLibFunctionChecked(lib, "glDeleteFramebuffers");
		FunctionTable[Gl2FuncName::DeleteProgram] = GetLibFunctionChecked(lib, "glDeleteProgram");
		FunctionTable[Gl2FuncName::DeleteRenderbuffers] = GetLibFunctionChecked(lib, "glDeleteRenderbuffers");
		FunctionTable[Gl2FuncName::DeleteShader] = GetLibFunctionChecked(lib, "glDeleteShader");
		FunctionTable[Gl2FuncName::DeleteTextures] = GetLibFunctionChecked(lib, "glDeleteTextures");
		FunctionTable[Gl2FuncName::DepthFunc] = GetLibFunctionChecked(lib, "glDepthFunc");
		FunctionTable[Gl2FuncName::DepthMask] = GetLibFunctionChecked(lib, "glDepthMask");
		FunctionTable[Gl2FuncName::DepthRangef] = GetLibFunctionChecked(lib, "glDepthRangef");
		FunctionTable[Gl2FuncName::DetachShader] = GetLibFunctionChecked(lib, "glDetachShader");
		FunctionTable[Gl2FuncName::Disable] = GetLibFunctionChecked(lib, "glDisable");
		FunctionTable[Gl2FuncName::DisableVertexAttribArray] = GetLibFunctionChecked(lib, "glDisableVertexAttribArray");
		FunctionTable[Gl2FuncName::DrawArrays] = GetLibFunctionChecked(lib, "glDrawArrays");
		FunctionTable[Gl2FuncName::DrawElements] = GetLibFunctionChecked(lib, "glDrawElements");
		FunctionTable[Gl2FuncName::Enable] = GetLibFunctionChecked(lib, "glEnable");
		FunctionTable[Gl2FuncName::EnableVertexAttribArray] = GetLibFunctionChecked(lib, "glEnableVertexAttribArray");
		FunctionTable[Gl2FuncName::Finish] = GetLibFunctionChecked(lib, "glFinish");
		FunctionTable[Gl2FuncName::Flush] = GetLibFunctionChecked(lib, "glFlush");
		FunctionTable[Gl2FuncName::FramebufferRenderbuffer] = GetLibFunctionChecked(lib, "glFramebufferRenderbuffer");
		FunctionTable[Gl2FuncName::FramebufferTexture2D] = GetLibFunctionChecked(lib, "glFramebufferTexture2D");
		FunctionTable[Gl2FuncName::FrontFace] = GetLibFunctionChecked(lib, "glFrontFace");
		FunctionTable[Gl2FuncName::GenBuffers] = GetLibFunctionChecked(lib, "glGenBuffers");
		FunctionTable[Gl2FuncName::GenerateMipmap] = GetLibFunctionChecked(lib, "glGenerateMipmap");
		FunctionTable[Gl2FuncName::GenFramebuffers] = GetLibFunctionChecked(lib, "glGenFramebuffers");
		FunctionTable[Gl2FuncName::GenRenderbuffers] = GetLibFunctionChecked(lib, "glGenRenderbuffers");
		FunctionTable[Gl2FuncName::GenTextures] = GetLibFunctionChecked(lib, "glGenTextures");
		FunctionTable[Gl2FuncName::GetActiveAttrib] = GetLibFunctionChecked(lib, "glGetActiveAttrib");
		FunctionTable[Gl2FuncName::GetActiveUniform] = GetLibFunctionChecked(lib, "glGetActiveUniform");
		FunctionTable[Gl2FuncName::GetAttachedShaders] = GetLibFunctionChecked(lib, "glGetAttachedShaders");
		FunctionTable[Gl2FuncName::GetAttribLocation] = GetLibFunctionChecked(lib, "glGetAttribLocation");
		FunctionTable[Gl2FuncName::GetBooleanv] = GetLibFunctionChecked(lib, "glGetBooleanv");
		FunctionTable[Gl2FuncName::GetBufferParameteriv] = GetLibFunctionChecked(lib, "glGetBufferParameteriv");
		FunctionTable[Gl2FuncName::GetError] = GetLibFunctionChecked(lib, "glGetError");
		FunctionTable[Gl2FuncName::GetFloatv] = GetLibFunctionChecked(lib, "glGetFloatv");
		FunctionTable[Gl2FuncName::GetFramebufferAttachmentParameteriv] = GetLibFunctionChecked(lib, "glGetFramebufferAttachmentParameteriv");
		FunctionTable[Gl2FuncName::GetIntegerv] = GetLibFunctionChecked(lib, "glGetIntegerv");
		FunctionTable[Gl2FuncName::GetProgramiv] = GetLibFunctionChecked(lib, "glGetProgramiv");
		FunctionTable[Gl2FuncName::GetProgramInfoLog] = GetLibFunctionChecked(lib, "glGetProgramInfoLog");
		FunctionTable[Gl2FuncName::GetRenderbufferParameteriv] = GetLibFunctionChecked(lib, "glGetRenderbufferParameteriv");
		FunctionTable[Gl2FuncName::GetShaderiv] = GetLibFunctionChecked(lib, "glGetShaderiv");
		FunctionTable[Gl2FuncName::GetShaderInfoLog] = GetLibFunctionChecked(lib, "glGetShaderInfoLog");
		FunctionTable[Gl2FuncName::GetShaderPrecisionFormat] = GetLibFunctionChecked(lib, "glGetShaderPrecisionFormat");
		FunctionTable[Gl2FuncName::GetShaderSource] = GetLibFunctionChecked(lib, "glGetShaderSource");
		FunctionTable[Gl2FuncName::GetString] = GetLibFunctionChecked(lib, "glGetString");
		FunctionTable[Gl2FuncName::GetTexParameterfv] = GetLibFunctionChecked(lib, "glGetTexParameterfv");
		FunctionTable[Gl2FuncName::GetTexParameteriv] = GetLibFunctionChecked(lib, "glGetTexParameteriv");
		FunctionTable[Gl2FuncName::GetUniformfv] = GetLibFunctionChecked(lib, "glGetUniformfv");
		FunctionTable[Gl2FuncName::GetUniformiv] = GetLibFunctionChecked(lib, "glGetUniformiv");
		FunctionTable[Gl2FuncName::GetUniformLocation] = GetLibFunctionChecked(lib, "glGetUniformLocation");
		FunctionTable[Gl2FuncName::GetVertexAttribfv] = GetLibFunctionChecked(lib, "glGetVertexAttribfv");
		FunctionTable[Gl2FuncName::GetVertexAttribiv] = GetLibFunctionChecked(lib, "glGetVertexAttribiv");
		FunctionTable[Gl2FuncName::GetVertexAttribPointerv] = GetLibFunctionChecked(lib, "glGetVertexAttribPointerv");
		FunctionTable[Gl2FuncName::Hint] = GetLibFunctionChecked(lib, "glHint");
		FunctionTable[Gl2FuncName::IsBuffer] = GetLibFunctionChecked(lib, "glIsBuffer");
		FunctionTable[Gl2FuncName::IsEnabled] = GetLibFunctionChecked(lib, "glIsEnabled");
		FunctionTable[Gl2FuncName::IsFramebuffer] = GetLibFunctionChecked(lib, "glIsFramebuffer");
		FunctionTable[Gl2FuncName::IsProgram] = GetLibFunctionChecked(lib, "glIsProgram");
		FunctionTable[Gl2FuncName::IsRenderbuffer] = GetLibFunctionChecked(lib, "glIsRenderbuffer");
		FunctionTable[Gl2FuncName::IsShader] = GetLibFunctionChecked(lib, "glIsShader");
		FunctionTable[Gl2FuncName::IsTexture] = GetLibFunctionChecked(lib, "glIsTexture");
		FunctionTable[Gl2FuncName::LineWidth] = GetLibFunctionChecked(lib, "glLineWidth");
		FunctionTable[Gl2FuncName::LinkProgram] = GetLibFunctionChecked(lib, "glLinkProgram");
		FunctionTable[Gl2FuncName::PixelStorei] = GetLibFunctionChecked(lib, "glPixelStorei");
		FunctionTable[Gl2FuncName::PolygonOffset] = GetLibFunctionChecked(lib, "glPolygonOffset");
		FunctionTable[Gl2FuncName::ReadPixels] = GetLibFunctionChecked(lib, "glReadPixels");
		FunctionTable[Gl2FuncName::ReleaseShaderCompiler] = GetLibFunctionChecked(lib, "glReleaseShaderCompiler");
		FunctionTable[Gl2FuncName::RenderbufferStorage] = GetLibFunctionChecked(lib, "glRenderbufferStorage");
		FunctionTable[Gl2FuncName::SampleCoverage] = GetLibFunctionChecked(lib, "glSampleCoverage");
		FunctionTable[Gl2FuncName::Scissor] = GetLibFunctionChecked(lib, "glScissor");
		FunctionTable[Gl2FuncName::ShaderBinary] = GetLibFunctionChecked(lib, "glShaderBinary");
		FunctionTable[Gl2FuncName::ShaderSource] = GetLibFunctionChecked(lib, "glShaderSource");
		FunctionTable[Gl2FuncName::StencilFunc] = GetLibFunctionChecked(lib, "glStencilFunc");
		FunctionTable[Gl2FuncName::StencilFuncSeparate] = GetLibFunctionChecked(lib, "glStencilFuncSeparate");
		FunctionTable[Gl2FuncName::StencilMask] = GetLibFunctionChecked(lib, "glStencilMask");
		FunctionTable[Gl2FuncName::StencilMaskSeparate] = GetLibFunctionChecked(lib, "glStencilMaskSeparate");
		FunctionTable[Gl2FuncName::StencilOp] = GetLibFunctionChecked(lib, "glStencilOp");
		FunctionTable[Gl2FuncName::StencilOpSeparate] = GetLibFunctionChecked(lib, "glStencilOpSeparate");
		FunctionTable[Gl2FuncName::TexImage2D] = GetLibFunctionChecked(lib, "glTexImage2D");
		FunctionTable[Gl2FuncName::TexParameterf] = GetLibFunctionChecked(lib, "glTexParameterf");
		FunctionTable[Gl2FuncName::TexParameterfv] = GetLibFunctionChecked(lib, "glTexParameterfv");
		FunctionTable[Gl2FuncName::TexParameteri] = GetLibFunctionChecked(lib, "glTexParameteri");
		FunctionTable[Gl2FuncName::TexParameteriv] = GetLibFunctionChecked(lib, "glTexParameteriv");
		FunctionTable[Gl2FuncName::TexSubImage2D] = GetLibFunctionChecked(lib, "glTexSubImage2D");
		FunctionTable[Gl2FuncName::Uniform1f] = GetLibFunctionChecked(lib, "glUniform1f");
		FunctionTable[Gl2FuncName::Uniform1fv] = GetLibFunctionChecked(lib, "glUniform1fv");
		FunctionTable[Gl2FuncName::Uniform1i] = GetLibFunctionChecked(lib, "glUniform1i");
		FunctionTable[Gl2FuncName::Uniform1iv] = GetLibFunctionChecked(lib, "glUniform1iv");
		FunctionTable[Gl2FuncName::Uniform2f] = GetLibFunctionChecked(lib, "glUniform2f");
		FunctionTable[Gl2FuncName::Uniform2fv] = GetLibFunctionChecked(lib, "glUniform2fv");
		FunctionTable[Gl2FuncName::Uniform2i] = GetLibFunctionChecked(lib, "glUniform2i");
		FunctionTable[Gl2FuncName::Uniform2iv] = GetLibFunctionChecked(lib, "glUniform2iv");
		FunctionTable[Gl2FuncName::Uniform3f] = GetLibFunctionChecked(lib, "glUniform3f");
		FunctionTable[Gl2FuncName::Uniform3fv] = GetLibFunctionChecked(lib, "glUniform3fv");
		FunctionTable[Gl2FuncName::Uniform3i] = GetLibFunctionChecked(lib, "glUniform3i");
		FunctionTable[Gl2FuncName::Uniform3iv] = GetLibFunctionChecked(lib, "glUniform3iv");
		FunctionTable[Gl2FuncName::Uniform4f] = GetLibFunctionChecked(lib, "glUniform4f");
		FunctionTable[Gl2FuncName::Uniform4fv] = GetLibFunctionChecked(lib, "glUniform4fv");
		FunctionTable[Gl2FuncName::Uniform4i] = GetLibFunctionChecked(lib, "glUniform4i");
		FunctionTable[Gl2FuncName::Uniform4iv] = GetLibFunctionChecked(lib, "glUniform4iv");
		FunctionTable[Gl2FuncName::UniformMatrix2fv] = GetLibFunctionChecked(lib, "glUniformMatrix2fv");
		FunctionTable[Gl2FuncName::UniformMatrix3fv] = GetLibFunctionChecked(lib, "glUniformMatrix3fv");
		FunctionTable[Gl2FuncName::UniformMatrix4fv] = GetLibFunctionChecked(lib, "glUniformMatrix4fv");
		FunctionTable[Gl2FuncName::UseProgram] = GetLibFunctionChecked(lib, "glUseProgram");
		FunctionTable[Gl2FuncName::ValidateProgram] = GetLibFunctionChecked(lib, "glValidateProgram");
		FunctionTable[Gl2FuncName::VertexAttrib1f] = GetLibFunctionChecked(lib, "glVertexAttrib1f");
		FunctionTable[Gl2FuncName::VertexAttrib1fv] = GetLibFunctionChecked(lib, "glVertexAttrib1fv");
		FunctionTable[Gl2FuncName::VertexAttrib2f] = GetLibFunctionChecked(lib, "glVertexAttrib2f");
		FunctionTable[Gl2FuncName::VertexAttrib2fv] = GetLibFunctionChecked(lib, "glVertexAttrib2fv");
		FunctionTable[Gl2FuncName::VertexAttrib3f] = GetLibFunctionChecked(lib, "glVertexAttrib3f");
		FunctionTable[Gl2FuncName::VertexAttrib3fv] = GetLibFunctionChecked(lib, "glVertexAttrib3fv");
		FunctionTable[Gl2FuncName::VertexAttrib4f] = GetLibFunctionChecked(lib, "glVertexAttrib4f");
		FunctionTable[Gl2FuncName::VertexAttrib4fv] = GetLibFunctionChecked(lib, "glVertexAttrib4fv");
		FunctionTable[Gl2FuncName::VertexAttribPointer] = GetLibFunctionChecked(lib, "glVertexAttribPointer");
		FunctionTable[Gl2FuncName::Viewport] = GetLibFunctionChecked(lib, "glViewport");
#else
