...
static const char* clLibName = "libOpenCL.dylib";
#else
...
inline LIBTYPE OpenOCLLibrary(const char* pszPath)
{
...
inline void CloseOCLLibrary(LIBTYPE hLib)
{
	FreeLibrary(hLib);
}

inline void* GetOCLLibFunction(LIBTYPE hLib, const char* pszName)
{
	if (hLib)
	{
#if defined(UNDER_CE)
...
inline void CloseOCLLibrary(LIBTYPE hLib) { dlclose(hLib); }
...
namespace cl {
namespace internals {
inline void* GetCLLibFunctionChecked(LIBTYPE hLib, const char* name)
{
	void* func = GetOCLLibFunction(hLib, name);
	if (!func)
	{
		Log_Error("Failed to load function [%s] from OpenCL library.", name);
	}
	return func;
}
}
...
inline void* getClFunction(CLFunctions::Enum func)
{
	...
	{
		LIBTYPE lib = OpenOCLLibrary(clLibName);
		if (lib)
		{
		...
		{
			lib = OpenOCLLibrary(clLibAltName);
			if (lib)
			{
		...
		CLFunctionTable[CLFunctions::GetPlatformIDs] = GetCLLibFunctionChecked(lib, "clGetPlatformIDs");
		CLFunctionTable[CLFunctions::GetPlatformInfo] = GetCLLibFunctionChecked(lib, "clGetPlatformInfo");
		CLFunctionTable[CLFunctions::GetDeviceIDs] = GetCLLibFunctionChecked(lib, "clGetDeviceIDs");
		CLFunctionTable[CLFunctions::GetDeviceInfo] = GetCLLibFunctionChecked(lib, "clGetDeviceInfo");
		CLFunctionTable[CLFunctions::CreateSubDevices] = GetCLLibFunctionChecked(lib, "clCreateSubDevices");
		CLFunctionTable[CLFunctions::RetainDevice] = GetCLLibFunctionChecked(lib, "clRetainDevice");
		CLFunctionTable[CLFunctions::ReleaseDevice] = GetCLLibFunctionChecked(lib, "clReleaseDevice");
		CLFunctionTable[CLFunctions::SetDefaultDeviceCommandQueue] = GetCLLibFunctionChecked(lib, "clSetDefaultDeviceCommandQueue");
		CLFunctionTable[CLFunctions::GetDeviceAndHostTimer] = GetCLLibFunctionChecked(lib, "clGetDeviceAndHostTimer");
		CLFunctionTable[CLFunctions::GetHostTimer] = GetCLLibFunctionChecked(lib, "clGetHostTimer");
		CLFunctionTable[CLFunctions::CreateContext] = GetCLLibFunctionChecked(lib, "clCreateContext");
		CLFunctionTable[CLFunctions::CreateContextFromType] = GetCLLibFunctionChecked(lib, "clCreateContextFromType");
		CLFunctionTable[CLFunctions::RetainContext] = GetCLLibFunctionChecked(lib, "clRetainContext");
		CLFunctionTable[CLFunctions::ReleaseContext] = GetCLLibFunctionChecked(lib, "clReleaseContext");
		CLFunctionTable[CLFunctions::GetContextInfo] = GetCLLibFunctionChecked(lib, "clGetContextInfo");
		CLFunctionTable[CLFunctions::CreateCommandQueueWithProperties] = GetCLLibFunctionChecked(lib, "clCreateCommandQueueWithProperties");
		CLFunctionTable[CLFunctions::RetainCommandQueue] = GetCLLibFunctionChecked(lib, "clRetainCommandQueue");
		CLFunctionTable[CLFunctions::ReleaseCommandQueue] = GetCLLibFunctionChecked(lib, "clReleaseCommandQueue");
		CLFunctionTable[CLFunctions::GetCommandQueueInfo] = GetCLLibFunctionChecked(lib, "clGetCommandQueueInfo");
		CLFunctionTable[CLFunctions::CreateBuffer] = GetCLLibFunctionChecked(lib, "clCreateBuffer");
		CLFunctionTable[CLFunctions::CreateSubBuffer] = GetCLLibFunctionChecked(lib, "clCreateSubBuffer");
		CLFunctionTable[CLFunctions::CreateImage] = GetCLLibFunctionChecked(lib, "clCreateImage");
		CLFunctionTable[CLFunctions::CreatePipe] = GetCLLibFunctionChecked(lib, "clCreatePipe");
		CLFunctionTable[CLFunctions::RetainMemObject] = GetCLLibFunctionChecked(lib, "clRetainMemObject");
		CLFunctionTable[CLFunctions::ReleaseMemObject] = GetCLLibFunctionChecked(lib, "clReleaseMemObject");
		CLFunctionTable[CLFunctions::GetSupportedImageFormats] = GetCLLibFunctionChecked(lib, "clGetSupportedImageFormats");
		CLFunctionTable[CLFunctions::GetMemObjectInfo] = GetCLLibFunctionChecked(lib, "clGetMemObjectInfo");
		CLFunctionTable[CLFunctions::GetImageInfo] = GetCLLibFunctionChecked(lib, "clGetImageInfo");
		CLFunctionTable[CLFunctions::GetPipeInfo] = GetCLLibFunctionChecked(lib, "clGetPipeInfo");
		CLFunctionTable[CLFunctions::SetMemObjectDestructorCallback] = GetCLLibFunctionChecked(lib, "clSetMemObjectDestructorCallback");
		CLFunctionTable[CLFunctions::SVMAlloc] = GetCLLibFunctionChecked(lib, "clSVMAlloc");
		CLFunctionTable[CLFunctions::SVMFree] = GetCLLibFunctionChecked(lib, "clSVMFree");
		CLFunctionTable[CLFunctions::CreateSamplerWithProperties] = GetCLLibFunctionChecked(lib, "clCreateSamplerWithProperties");
		CLFunctionTable[CLFunctions::RetainSampler] = GetCLLibFunctionChecked(lib, "clRetainSampler");
		CLFunctionTable[CLFunctions::ReleaseSampler] = GetCLLibFunctionChecked(lib, "clReleaseSampler");
		CLFunctionTable[CLFunctions::GetSamplerInfo] = GetCLLibFunctionChecked(lib, "clGetSamplerInfo");
		CLFunctionTable[CLFunctions::CreateProgramWithSource] = GetCLLibFunctionChecked(lib, "clCreateProgramWithSource");
		CLFunctionTable[CLFunctions::CreateProgramWithBinary] = GetCLLibFunctionChecked(lib, "clCreateProgramWithBinary");
		CLFunctionTable[CLFunctions::CreateProgramWithBuiltInKernels] = GetCLLibFunctionChecked(lib, "clCreateProgramWithBuiltInKernels");
		CLFunctionTable[CLFunctions::CreateProgramWithIL] = GetCLLibFunctionChecked(lib, "clCreateProgramWithIL");
		CLFunctionTable[CLFunctions::RetainProgram] = GetCLLibFunctionChecked(lib, "clRetainProgram");
		CLFunctionTable[CLFunctions::ReleaseProgram] = GetCLLibFunctionChecked(lib, "clReleaseProgram");
		CLFunctionTable[CLFunctions::BuildProgram] = GetCLLibFunctionChecked(lib, "clBuildProgram");
		CLFunctionTable[CLFunctions::CompileProgram] = GetCLLibFunctionChecked(lib, "clCompileProgram");
		CLFunctionTable[CLFunctions::LinkProgram] = GetCLLibFunctionChecked(lib, "clLinkProgram");
		CLFunctionTable[CLFunctions::SetProgramReleaseCallback] = GetCLLibFunctionChecked(lib, "clSetProgramReleaseCallback");
		CLFunctionTable[CLFunctions::SetProgramSpecializationConstant] = GetCLLibFunctionChecked(lib, "clSetProgramSpecializationConstant");
		CLFunctionTable[CLFunctions::UnloadPlatformCompiler] = GetCLLibFunctionChecked(lib, "clUnloadPlatformCompiler");
		CLFunctionTable[CLFunctions::GetProgramInfo] = GetCLLibFunctionChecked(lib, "clGetProgramInfo");
		CLFunctionTable[CLFunctions::GetProgramBuildInfo] = GetCLLibFunctionChecked(lib, "clGetProgramBuildInfo");
		CLFunctionTable[CLFunctions::CreateKernel] = GetCLLibFunctionChecked(lib, "clCreateKernel");
		CLFunctionTable[CLFunctions::CreateKernelsInProgram] = GetCLLibFunctionChecked(lib, "clCreateKernelsInProgram");
		CLFunctionTable[CLFunctions::CloneKernel] = GetCLLibFunctionChecked(lib, "clCloneKernel");
		CLFunctionTable[CLFunctions::RetainKernel] = GetCLLibFunctionChecked(lib, "clRetainKernel");
		CLFunctionTable[CLFunctions::ReleaseKernel] = GetCLLibFunctionChecked(lib, "clReleaseKernel");
		CLFunctionTable[CLFunctions::SetKernelArg] = GetCLLibFunctionChecked(lib, "clSetKernelArg");
		CLFunctionTable[CLFunctions::SetKernelArgSVMPointer] = GetCLLibFunctionChecked(lib, "clSetKernelArgSVMPointer");
		CLFunctionTable[CLFunctions::SetKernelExecInfo] = GetCLLibFunctionChecked(lib, "clSetKernelExecInfo");
		CLFunctionTable[CLFunctions::GetKernelInfo] = GetCLLibFunctionChecked(lib, "clGetKernelInfo");
		CLFunctionTable[CLFunctions::GetKernelArgInfo] = GetCLLibFunctionChecked(lib, "clGetKernelArgInfo");
		CLFunctionTable[CLFunctions::GetKernelWorkGroupInfo] = GetCLLibFunctionChecked(lib, "clGetKernelWorkGroupInfo");
		CLFunctionTable[CLFunctions::GetKernelSubGroupInfo] = GetCLLibFunctionChecked(lib, "clGetKernelSubGroupInfo");
		CLFunctionTable[CLFunctions::WaitForEvents] = GetCLLibFunctionChecked(lib, "clWaitForEvents");
		CLFunctionTable[CLFunctions::GetEventInfo] = GetCLLibFunctionChecked(lib, "clGetEventInfo");
		CLFunctionTable[CLFunctions::CreateUserEvent] = GetCLLibFunctionChecked(lib, "clCreateUserEvent");
		CLFunctionTable[CLFunctions::RetainEvent] = GetCLLibFunctionChecked(lib, "clRetainEvent");
		CLFunctionTable[CLFunctions::ReleaseEvent] = GetCLLibFunctionChecked(lib, "clReleaseEvent");
		CLFunctionTable[CLFunctions::SetUserEventStatus] = GetCLLibFunctionChecked(lib, "clSetUserEventStatus");
		CLFunctionTable[CLFunctions::SetEventCallback] = GetCLLibFunctionChecked(lib, "clSetEventCallback");
		CLFunctionTable[CLFunctions::GetEventProfilingInfo] = GetCLLibFunctionChecked(lib, "clGetEventProfilingInfo");
		CLFunctionTable[CLFunctions::Flush] = GetCLLibFunctionChecked(lib, "clFlush");
		CLFunctionTable[CLFunctions::Finish] = GetCLLibFunctionChecked(lib, "clFinish");
		CLFunctionTable[CLFunctions::EnqueueReadBuffer] = GetCLLibFunctionChecked(lib, "clEnqueueReadBuffer");
		CLFunctionTable[CLFunctions::EnqueueReadBufferRect] = GetCLLibFunctionChecked(lib, "clEnqueueReadBufferRect");
		CLFunctionTable[CLFunctions::EnqueueWriteBuffer] = GetCLLibFunctionChecked(lib, "clEnqueueWriteBuffer");
		CLFunctionTable[CLFunctions::EnqueueWriteBufferRect] = GetCLLibFunctionChecked(lib, "clEnqueueWriteBufferRect");
		CLFunctionTable[CLFunctions::EnqueueFillBuffer] = GetCLLibFunctionChecked(lib, "clEnqueueFillBuffer");
		CLFunctionTable[CLFunctions::EnqueueCopyBuffer] = GetCLLibFunctionChecked(lib, "clEnqueueCopyBuffer");
		CLFunctionTable[CLFunctions::EnqueueCopyBufferRect] = GetCLLibFunctionChecked(lib, "clEnqueueCopyBufferRect");
		CLFunctionTable[CLFunctions::EnqueueReadImage] = GetCLLibFunctionChecked(lib, "clEnqueueReadImage");
		CLFunctionTable[CLFunctions::EnqueueWriteImage] = GetCLLibFunctionChecked(lib, "clEnqueueWriteImage");
		CLFunctionTable[CLFunctions::EnqueueFillImage] = GetCLLibFunctionChecked(lib, "clEnqueueFillImage");
		CLFunctionTable[CLFunctions::EnqueueCopyImage] = GetCLLibFunctionChecked(lib, "clEnqueueCopyImage");
		CLFunctionTable[CLFunctions::EnqueueCopyImageToBuffer] = GetCLLibFunctionChecked(lib, "clEnqueueCopyImageToBuffer");
		CLFunctionTable[CLFunctions::EnqueueCopyBufferToImage] = GetCLLibFunctionChecked(lib, "clEnqueueCopyBufferToImage");
		CLFunctionTable[CLFunctions::EnqueueMapBuffer] = GetCLLibFunctionChecked(lib, "clEnqueueMapBuffer");
		CLFunctionTable[CLFunctions::EnqueueMapImage] = GetCLLibFunctionChecked(lib, "clEnqueueMapImage");
		CLFunctionTable[CLFunctions::EnqueueUnmapMemObject] = GetCLLibFunctionChecked(lib, "clEnqueueUnmapMemObject");
		CLFunctionTable[CLFunctions::EnqueueMigrateMemObjects] = GetCLLibFunctionChecked(lib, "clEnqueueMigrateMemObjects");
		CLFunctionTable[CLFunctions::EnqueueNDRangeKernel] = GetCLLibFunctionChecked(lib, "clEnqueueNDRangeKernel");
		CLFunctionTable[CLFunctions::EnqueueNativeKernel] = GetCLLibFunctionChecked(lib, "clEnqueueNativeKernel");
		CLFunctionTable[CLFunctions::EnqueueMarkerWithWaitList] = GetCLLibFunctionChecked(lib, "clEnqueueMarkerWithWaitList");
		CLFunctionTable[CLFunctions::EnqueueBarrierWithWaitList] = GetCLLibFunctionChecked(lib, "clEnqueueBarrierWithWaitList");
		CLFunctionTable[CLFunctions::EnqueueSVMFree] = GetCLLibFunctionChecked(lib, "clEnqueueSVMFree");
		CLFunctionTable[CLFunctions::EnqueueSVMMemcpy] = GetCLLibFunctionChecked(lib, "clEnqueueSVMMemcpy");
		CLFunctionTable[CLFunctions::EnqueueSVMMemFill] = GetCLLibFunctionChecked(lib, "clEnqueueSVMMemFill");
		CLFunctionTable[CLFunctions::EnqueueSVMMap] = GetCLLibFunctionChecked(lib, "clEnqueueSVMMap");
		CLFunctionTable[CLFunctions::EnqueueSVMUnmap] = GetCLLibFunctionChecked(lib, "clEnqueueSVMUnmap");
		CLFunctionTable[CLFunctions::EnqueueSVMMigrateMem] = GetCLLibFunctionChecked(lib, "clEnqueueSVMMigrateMem");
		CLFunctionTable[CLFunctions::GetExtensionFunctionAddressForPlatform] = GetCLLibFunctionChecked(lib, "clGetExtensionFunctionAddressForPlatform");
		CLFunctionTable[CLFunctions::CreateImage2D] = GetCLLibFunctionChecked(lib, "clCreateImage2D");
		CLFunctionTable[CLFunctions::CreateImage3D] = GetCLLibFunctionChecked(lib, "clCreateImage3D");
		CLFunctionTable[CLFunctions::EnqueueMarker] = GetCLLibFunctionChecked(lib, "clEnqueueMarker");
		CLFunctionTable[CLFunctions::EnqueueWaitForEvents] = GetCLLibFunctionChecked(lib, "clEnqueueWaitForEvents");
		CLFunctionTable[CLFunctions::EnqueueBarrier] = GetCLLibFunctionChecked(lib, "clEnqueueBarrier");
		CLFunctionTable[CLFunctions::UnloadCompiler] = GetCLLibFunctionChecked(lib, "clUnloadCompiler");
		CLFunctionTable[CLFunctions::GetExtensionFunctionAddress] = GetCLLibFunctionChecked(lib, "clGetExtensionFunctionAddress");
		CLFunctionTable[CLFunctions::CreateCommandQueue] = GetCLLibFunctionChecked(lib, "clCreateCommandQueue");
		CLFunctionTable[CLFunctions::CreateSampler] = GetCLLibFunctionChecked(lib, "clCreateSampler");
		CLFunctionTable[CLFunctions::EnqueueTask] = GetCLLibFunctionChecked(lib, "clEnqueueTask");
		CLFunctionTable[CLFunctions::CreateFromGLBuffer] = GetCLLibFunctionChecked(lib, "clCreateFromGLBuffer");
		CLFunctionTable[CLFunctions::CreateFromGLTexture] = GetCLLibFunctionChecked(lib, "clCreateFromGLTexture");
		CLFunctionTable[CLFunctions::CreateFromGLRenderbuffer] = GetCLLibFunctionChecked(lib, "clCreateFromGLRenderbuffer");
		CLFunctionTable[CLFunctions::GetGLObjectInfo] = GetCLLibFunctionChecked(lib, "clGetGLObjectInfo");
		CLFunctionTable[CLFunctions::GetGLTextureInfo] = GetCLLibFunctionChecked(lib, "clGetGLTextureInfo");
		CLFunctionTable[CLFunctions::EnqueueAcquireGLObjects] = GetCLLibFunctionChecked(lib, "clEnqueueAcquireGLObjects");
		CLFunctionTable[CLFunctions::EnqueueReleaseGLObjects] = GetCLLibFunctionChecked(lib, "clEnqueueReleaseGLObjects");
		CLFunctionTable[CLFunctions::CreateFromGLTexture2D] = GetCLLibFunctionChecked(lib, "clCreateFromGLTexture2D");
		CLFunctionTable[CLFunctions::CreateFromGLTexture3D] = GetCLLibFunctionChecked(lib, "clCreateFromGLTexture3D");
		CLFunctionTable[CLFunctions::GetGLContextInfoKHR] = GetCLLibFunctionChecked(lib, "clGetGLContextInfoKHR");
	}
