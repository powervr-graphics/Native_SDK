...
function(add_spirv_shaders_to_target TARGET_NAME)
	...
	foreach(RELATIVE_PATH ${ARGUMENTS_FILE_LIST})
		...
		set (GLSLANG_VALIDATOR_COMPILE_CURRENT_COMMAND $ENV{VULKAN_SDK}/Bin/glslangValidator ${ARGUMENTS_GLSLANG_ARGUMENTS} --target-env ${ARGUMENTS_VULKAN_TARGET_ENV} ${ARGUMENTS_BASE_PATH}${RELATIVE_PATH} -o ${ARGUMENTS_SPIRV_OUTPUT_FOLDER}${RELATIVE_PATH}.spv -S ${SHADER_TYPE})
		add_custom_command(
