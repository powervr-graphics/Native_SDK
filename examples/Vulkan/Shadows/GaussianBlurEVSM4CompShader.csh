...
layout(set = 1, binding = 0, rgba16f) uniform highp writeonly image2D oShadowMap;
...
vec4 getMoment(vec2 texcoord)
{
	...
	return vec4(vsmDepth.xy, vsmDepth.xy * vsmDepth.xy);
}
...
void main()
{
	...
	imageStore(oShadowMap, globalCoord, M1M2);
	...
	imageStore(oShadowMap, globalCoord + ivec2(0, 4), M1M2);
}