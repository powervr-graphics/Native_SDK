...
uniform layout(rgba8, set = 0, binding = 0) readonly mediump image2D imageIn;
uniform layout(rgba8, set = 0, binding = 1) writeonly mediump image2D imageOut;
...
const mediump float Weights[] = float[](0.000003814697266, 0.000068664550781, 0.000583648681641, 0.003112792968750, 0.011672973632813, 0.032684326171875, 0.070816040039063,
	0.121398925781250, 0.166923522949219, 0.185470581054688, 0.166923522949219, 0.121398925781250, 0.070816040039063, 0.032684326171875, 0.011672973632813, 0.003112792968750,
	0.000583648681641, 0.000068664550781, 0.000003814697266,
...
void main()
{
	...
	mediump vec3 f[GaussianKernelSize];
