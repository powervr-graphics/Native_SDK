...
uniform layout(rgba16f, set = 0, binding = 0) readonly mediump image2D imageIn;
uniform layout(rgba16f, set = 0, binding = 1) writeonly mediump image2D imageOut;
...
void main()
{
	...
	mediump float f[MaxGaussianKernel];
