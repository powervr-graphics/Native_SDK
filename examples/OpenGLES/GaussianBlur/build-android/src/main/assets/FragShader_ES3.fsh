...
void main()
{
	...
	{
		//Sigma = 5;
		mediump const float w[] = float[](0.016815, 0.023597, 0.031821, 0.041234, 0.051343, 0.061432, 0.07063, 0.078033, 0.082841, 0.084509, 0.082841, 0.078033, 0.07063, 0.061432, 0.051343, 0.041234, 0.031821, 0.023597, 0.016815);

		//combined_weight -- ILLUSTRATION PURPOSES - THESE CALCULATIONS CAN BE DONE CPU-SIDE AND LOADED AS UNIFORMS
		mediump const float c_w[] = float[]
		...
		mediump float o_[] = float[](-texelHeight * 9., -texelHeight * 8., -texelHeight * 7., -texelHeight * 6., -texelHeight * 5., -texelHeight * 4., -texelHeight * 3., -texelHeight * 2., -texelHeight, 0., texelHeight, texelHeight * 2., texelHeight * 3., texelHeight * 4., texelHeight * 5., texelHeight * 6., texelHeight * 7., texelHeight * 8., texelHeight * 9.);
		mediump float o[] = float[](
