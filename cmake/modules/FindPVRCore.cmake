...
if(PVR_PREBUILT_DEPENDENCIES)
	if(ANDROID)
        ...
        file(GLOB PVRCore_DIR_GLOB "${CMAKE_CURRENT_LIST_DIR}/../../framework/PVRCamera/build-android/.cxx/*/*/${ANDROID_ABI}/PVRCore")

        # The glob will return a list, but there should only be one match.
        if(PVRCore_DIR_GLOB)
            list(GET PVRCore_DIR_GLOB 0 PVRCore_DIR)
        else()
            message(STATUS "PVRCore: No build directory found matching ${CMAKE_CURRENT_LIST_DIR}/../../framework/PVRCamera/build-android/.cxx/*/*/${ANDROID_ABI}/PVRCore")
        endif()
	endif()
endif()
