...
set(CMAKE_SYSTEM_PROCESSOR "mips_32")
...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -march=mips32r6 -mabi=32 -EL" CACHE STRING "")
set(CMAKE_C_FLAGS   "${CMAKE_C_FLAGS} -march=mips32r6 -mabi=32 -EL" CACHE STRING "")

set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -march=mips32r6 -mabi=32 -EL" CACHE STRING "")
