...
ASSETDIR := $(PVRSDKDIR)/Examples/Navigation/Navigation2D/Vulkan/Build/Android/assets
...
# Module VulkanNavigation2D
include $(CLEAR_VARS)

LOCAL_MODULE    := VulkanNavigation2D

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := VulkanNavigation2D.cpp \
                    ../NavDataProcess.cpp
