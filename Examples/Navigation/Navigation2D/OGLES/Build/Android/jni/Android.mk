...
ASSETDIR := $(PVRSDKDIR)/Examples/Navigation/Navigation2D/OGLES/Build/Android/assets
...
# Module OGLESNavigation2D
include $(CLEAR_VARS)

LOCAL_MODULE    := OGLESNavigation2D

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := OGLESNavigation2D.cpp \
                    ../NavDataProcess.cpp
