...
ASSETDIR := $(PVRSDKDIR)/Examples/Beginner/05_IntroducingUIRenderer/Vulkan/Build/Android/assets
...
# Module VulkanIntroducingUIRenderer
include $(CLEAR_VARS)

LOCAL_MODULE    := VulkanIntroducingUIRenderer

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := VulkanIntroducingUIRenderer.cpp
