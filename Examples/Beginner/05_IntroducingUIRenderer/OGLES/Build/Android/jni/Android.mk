...
ASSETDIR := $(PVRSDKDIR)/Examples/Beginner/05_IntroducingUIRenderer/OGLES/Build/Android/assets
...
# Module OGLESIntroducingUIRenderer
include $(CLEAR_VARS)

LOCAL_MODULE    := OGLESIntroducingUIRenderer

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := OGLESIntroducingUIRenderer.cpp
