...
ASSETDIR := $(PVRSDKDIR)/Examples/Beginner/05_IntroUIRenderer/OGLES/Build/Android/assets
...
# Module OGLESIntroUIRenderer
include $(CLEAR_VARS)

LOCAL_MODULE    := OGLESIntroUIRenderer

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := OGLESIntroUIRenderer.cpp
