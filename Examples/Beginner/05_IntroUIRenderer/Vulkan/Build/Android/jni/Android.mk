...
ASSETDIR := $(PVRSDKDIR)/Examples/Beginner/05_IntroUIRenderer/Vulkan/Build/Android/assets
...
# Module VulkanIntroUIRenderer
include $(CLEAR_VARS)

LOCAL_MODULE    := VulkanIntroUIRenderer

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := VkIntroUIRenderer.cpp
