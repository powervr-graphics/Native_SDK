...
/*!*****************************************************************************************************************************************
 ...
 @Return		Whether the function succeeded or not.
 @Description	Creates an EGLDisplay from a native display, and initialises it.
*******************************************************************************************************************************************/
...
int main(int /*argc*/, char **/*argv*/)
{
	...
	if (!CreateWindowAndDisplay(nativeWindow, nativeDisplay))
	{
		goto cleanup;
	}
...
/*******************************************************************************************************************************************
 End of file (OGLES2HelloAPI_EWS.cpp)
*******************************************************************************************************************************************/
