/*******************************************************************************************************************************************
 ...
 @File         OGLESHelloAPI_LinuxDRM.cpp
...
*******************************************************************************************************************************************/
bool RenderScene( EGLDisplay eglDisplay, EGLSurface eglSurface, DRMVariables& data) 
{
	/*	Set the clear color
...
int main(int /*argc*/, char **/*argv*/)
{
	...
	for (int i = 0; i < 800; ++i)
	{
		if (!RenderScene(eglDisplay, eglSurface, data))
		{
			break;
		}
	}
...
/*******************************************************************************************************************************************
 End of file (OGLESHelloAPI_LinuxDRM.cpp)
*******************************************************************************************************************************************/
