        ...
        const char* interface, uint32_t version)
{
    ...
    {
        wlCompositor = (wl_compositor *) wl_registry_bind(registry, name,
                                                          &wl_compositor_interface, 1);
    }
    else if (strcmp(interface, "wl_shell") == 0)
    {
        wlShell = (wl_shell *) wl_registry_bind(registry, name,
...
bool initializeWindow()
{
    ...
    wl_shell_surface_set_title(wlShellSurface, "OGLESHelloApi");
    return true;
}
