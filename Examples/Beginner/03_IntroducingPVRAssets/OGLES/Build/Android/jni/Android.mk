...
ASSETDIR := $(PVRSDKDIR)/Examples/Beginner/03_IntroducingPVRAssets/OGLES/Build/Android/assets
...
# Module OGLESIntroducingPVRAssets
include $(CLEAR_VARS)

LOCAL_MODULE    := OGLESIntroducingPVRAssets

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := OGLESIntroducingPVRAssets.cpp
