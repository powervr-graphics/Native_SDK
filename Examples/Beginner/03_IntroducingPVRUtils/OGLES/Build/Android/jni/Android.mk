...
ASSETDIR := $(PVRSDKDIR)/Examples/Beginner/03_IntroducingPVRUtils/OGLES/Build/Android/assets
...
# Module OGLESIntroducingPVRUtils
include $(CLEAR_VARS)

LOCAL_MODULE    := OGLESIntroducingPVRUtils

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := OGLESIntroducingPVRUtils.cpp
