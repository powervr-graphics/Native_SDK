...
ASSETDIR := $(PVRSDKDIR)/Examples/Beginner/03_IntroducingPVRUtils/Vulkan/Build/Android/assets
...
# Module VulkanIntroducingPVRUtils
include $(CLEAR_VARS)

LOCAL_MODULE    := VulkanIntroducingPVRUtils

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := VulkanIntroducingPVRUtils.cpp
