...
ASSETDIR := $(PVRSDKDIR)/Examples/Advanced/ExampleUI/Vulkan/Build/Android/assets
...
# Module VulkanExampleUI
include $(CLEAR_VARS)

LOCAL_MODULE    := VulkanExampleUI

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := VulkanExampleUI.cpp
