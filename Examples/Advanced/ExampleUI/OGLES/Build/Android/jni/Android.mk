...
ASSETDIR := $(PVRSDKDIR)/Examples/Advanced/ExampleUI/OGLES/Build/Android/assets
...
# Module OGLESExampleUI
include $(CLEAR_VARS)

LOCAL_MODULE    := OGLESExampleUI

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := OGLESExampleUI.cpp
