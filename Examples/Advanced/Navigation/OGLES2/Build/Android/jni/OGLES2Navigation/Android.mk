...
# Module OGLES2Navigation
include $(CLEAR_VARS)

LOCAL_MODULE    := OGLES2Navigation

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := Examples/Advanced/Navigation/OGLES2/OGLES2Navigation.cpp \
                    Shell/PVRShell.cpp \
...
$(ASSETDIR)/StreetSigns.pvr: $(PVRSDKDIR)/Examples/Advanced/Navigation/OGLES2/StreetSigns.pvr $(ASSETDIR)
...
$(ASSETDIR)/AlphaMaskFragShader.fsh: $(PVRSDKDIR)/Examples/Advanced/Navigation/OGLES2/AlphaMaskFragShader.fsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/AntiAliasedLinesFragShader.fsh: $(PVRSDKDIR)/Examples/Advanced/Navigation/OGLES2/AntiAliasedLinesFragShader.fsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/AntiAliasedLinesVertShader.vsh: $(PVRSDKDIR)/Examples/Advanced/Navigation/OGLES2/AntiAliasedLinesVertShader.vsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/FragShader.fsh: $(PVRSDKDIR)/Examples/Advanced/Navigation/OGLES2/FragShader.fsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/VertShader.vsh: $(PVRSDKDIR)/Examples/Advanced/Navigation/OGLES2/VertShader.vsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/PivotQuadFragShader.fsh: $(PVRSDKDIR)/Examples/Advanced/Navigation/OGLES2/PivotQuadFragShader.fsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/PivotQuadMaskedFragShader.fsh: $(PVRSDKDIR)/Examples/Advanced/Navigation/OGLES2/PivotQuadMaskedFragShader.fsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/PivotQuadVertShader.vsh: $(PVRSDKDIR)/Examples/Advanced/Navigation/OGLES2/PivotQuadVertShader.vsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")
