...
*****************************************************************************/
bool OGLES2Skybox2::LoadEffect( CPVRTPFXEffect **ppEffect, const char * pszEffectName, const char *pszFileName )
{
	if(!ppEffect)
		return false;
...
*****************************************************************************/
bool OGLES2Skybox2::DestroyEffect(CPVRTPFXEffect **ppEffect)
{
	if(ppEffect)
	{
		if(*ppEffect)
...
*****************************************************************************/
void OGLES2Skybox2::ChangeSkyboxTo(CPVRTPFXEffect *pEffect, GLuint ui32NewSkybox)
{
	const CPVRTArray<SPVRTPFXTexture>& sTex = pEffect->GetTextureArray();
