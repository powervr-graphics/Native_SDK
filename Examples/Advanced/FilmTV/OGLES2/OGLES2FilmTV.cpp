...
class OGLES2FilmTV : public PVRShell
{
        ...
        CPVRTgles2Ext::PFNGLFRAMEBUFFERTEXTURE2DMULTISAMPLEEXT glFramebufferTexture2DMultisampleEXT;
        CPVRTgles2Ext::PFNGLRENDERBUFFERSTORAGEMULTISAMPLEEXT glRenderbufferStorageMultisampleEXT;

        bool m_bMultisampledRenderToTextureIMGSupported;
        CPVRTgles2Ext::PFNGLFRAMEBUFFERTEXTURE2DMULTISAMPLEIMG glFramebufferTexture2DMultisampleIMG;
        CPVRTgles2Ext::PFNGLRENDERBUFFERSTORAGEMULTISAMPLEIMG glRenderbufferStorageMultisampleIMG;
...
bool OGLES2FilmTV::InitView()
{
    ...
    CPVRTgles2Ext ext;
    ext.LoadExtensions();
    if (CPVRTgles2Ext::IsGLExtensionSupported("GL_EXT_multisampled_render_to_texture"))
    {
        ...
        glGetIntegerv(GL_MAX_SAMPLES_EXT, &m_iMaxSamples);
    }
    else
    {
        ...
        if (CPVRTgles2Ext::IsGLExtensionSupported("GL_IMG_multisampled_render_to_texture"))
        {
