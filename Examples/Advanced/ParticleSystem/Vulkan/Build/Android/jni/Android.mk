...
ASSETDIR := $(PVRSDKDIR)/Examples/Advanced/ParticleSystem/Vulkan/Build/Android/assets
...
# Module VulkanParticleSystem
include $(CLEAR_VARS)

LOCAL_MODULE    := VulkanParticleSystem

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := VulkanParticleSystem.cpp \
