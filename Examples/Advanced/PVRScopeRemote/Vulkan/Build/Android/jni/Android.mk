...
ASSETDIR := $(PVRSDKDIR)/Examples/Advanced/PVRScopeRemote/Vulkan/Build/Android/assets
...
# Module VulkanPVRScopeRemote
include $(CLEAR_VARS)

LOCAL_MODULE    := VulkanPVRScopeRemote

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := VulkanPVRScopeRemote.cpp
...
LOCAL_STATIC_LIBRARIES := PVRUIRenderer PVRVulkan PVRNativeVulkan PVRVulkanGlue PVRAssets PVRCore PVRScopeDeveloper android_native_app_glue
