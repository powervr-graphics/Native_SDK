...
$(ASSETDIR)/MaskTex.pvr: $(PVRSDKDIR)/Examples/Advanced/PVRScopeRemote/OGLES/MaskTex.pvr $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/Mask.pod: $(PVRSDKDIR)/Examples/Advanced/PVRScopeRemote/OGLES/Mask.pod $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")
