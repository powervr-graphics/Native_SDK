...
ASSETDIR := $(PVRSDKDIR)/Examples/Advanced/Skinning/Vulkan/Build/Android/assets
...
# Module VulkanSkinning
include $(CLEAR_VARS)

LOCAL_MODULE    := VulkanSkinning

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := VulkanSkinning.cpp
