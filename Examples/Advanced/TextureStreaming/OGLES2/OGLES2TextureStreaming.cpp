/*!****************************************************************************
 @File          OGLES2TextureStreaming.cpp
 ...
 ******************************************************************************/
class OGLES2TextureStreaming : public PVRShell
{
 ...
 ******************************************************************************/
bool OGLES2TextureStreaming::LoadTextures(CPVRTString* pErrorStr)
{
	/*
	 Loads the textures.
 ...
 ******************************************************************************/
bool OGLES2TextureStreaming::LoadShaders(CPVRTString* pErrorStr)
{
	/*
	...
	for(int idx = 0; idx < eNumEffects; ++idx)
	{
		if(PVRTShaderLoadFromFile(NULL,                         // Binary shader source file
								  ...
								  NULL,                         // Context (not required for OGLES2)
 ...
 ******************************************************************************/
bool OGLES2TextureStreaming::LoadVbos(CPVRTString* pErrorStr)
{
...
/*!****************************************************************************
 ...
 @Description	Code in InitApplication() will be called by PVRShell once per
				...
				not be called again.
******************************************************************************/
bool OGLES2TextureStreaming::InitApplication()
{
	m_i32Frame       = 0;
	m_puiVbo         = 0;
	m_puiIndexVbo    = 0;
...
/*!****************************************************************************
 ...
 @Description	Code in QuitApplication() will be called by PVRShell once per
				...
				not be called.
******************************************************************************/
bool OGLES2TextureStreaming::QuitApplication()
{
...
******************************************************************************/
bool OGLES2TextureStreaming::InitView()
{
...
******************************************************************************/
bool OGLES2TextureStreaming::ReleaseView()
{
	// Clean up AV capture
...
******************************************************************************/
bool OGLES2TextureStreaming::RenderScene()
{
 ...
 *****************************************************************************/
void OGLES2TextureStreaming::DrawPODScene(const PVRTMat4 &mViewProjection)
{
 ...
 ******************************************************************************/
void OGLES2TextureStreaming::DrawMesh(int i32MeshIndex, bool bNormals)
{
...
PVRShell* NewDemo()
{
	return new OGLES2TextureStreaming();
}

/******************************************************************************
 End of file (OGLES2TextureStreaming.cpp)
******************************************************************************/
