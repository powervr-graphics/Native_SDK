...
ASSETDIR := $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES3/Build/Android/assets
...
# Module OGLES3Navigation3D
include $(CLEAR_VARS)

LOCAL_MODULE    := OGLES3Navigation3D

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := Examples/Advanced/Navigation3D/OGLES3/OGLES3Navigation3D.cpp \
                    Shell/PVRShell.cpp \
...
$(ASSETDIR)/Skybox.pvr: $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES3/Skybox.pvr $(ASSETDIR)
...
$(ASSETDIR)/UIVertShader.vsh: $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES3/UIVertShader.vsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/UIFragShader.fsh: $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES3/UIFragShader.fsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/SkyboxFragShader.fsh: $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES3/SkyboxFragShader.fsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/SkyboxVertShader.vsh: $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES3/SkyboxVertShader.vsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/BuildingFragShader.fsh: $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES3/BuildingFragShader.fsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/BuildingVertShader.vsh: $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES3/BuildingVertShader.vsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/FullscreenVertShader.vsh: $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES3/FullscreenVertShader.vsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/FullscreenFragShader.fsh: $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES3/FullscreenFragShader.fsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/ShadowVolVertShader.vsh: $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES3/ShadowVolVertShader.vsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/ShadowVolFragShader.fsh: $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES3/ShadowVolFragShader.fsh $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")
