...
# Module OGLESNavigation3D
include $(CLEAR_VARS)

LOCAL_MODULE    := OGLESNavigation3D

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := Examples/Advanced/Navigation3D/OGLES/OGLESNavigation3D.cpp \
                    Shell/PVRShell.cpp \
...
$(ASSETDIR)/skybox1.pvr: $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES/skybox1.pvr $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/skybox2.pvr: $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES/skybox2.pvr $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/skybox3.pvr: $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES/skybox3.pvr $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/skybox4.pvr: $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES/skybox4.pvr $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/skybox5.pvr: $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES/skybox5.pvr $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")

$(ASSETDIR)/skybox6.pvr: $(PVRSDKDIR)/Examples/Advanced/Navigation3D/OGLES/skybox6.pvr $(ASSETDIR)
	$(CPY) $(subst /,$(SEPARATOR),"$<" "$(ASSETDIR)")
