...
ASSETDIR := $(PVRSDKDIR)/Examples/Advanced/DeferredShading/OGLES/Build/Android/assets
...
# Module OGLESDeferredShading
include $(CLEAR_VARS)

LOCAL_MODULE    := OGLESDeferredShading

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := OGLESDeferredShading.cpp
