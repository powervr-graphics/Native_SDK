...
ASSETDIR := $(PVRSDKDIR)/Examples/Advanced/GnomeHorde/Vulkan/Build/Android/assets
...
# Module VulkanGnomeHorde
include $(CLEAR_VARS)

LOCAL_MODULE    := VulkanGnomeHorde

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := VulkanGnomeHorde.cpp
