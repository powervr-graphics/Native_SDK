/******************************************************************************
 ...
 @File         OGLES2OcclusionQueries.cpp
...
******************************************************************************/
class OGLES2OcclusionQueries : public PVRShell
{
...
******************************************************************************/
bool OGLES2OcclusionQueries::LoadTextures(CPVRTString* const pszErrorStr)
{
...
******************************************************************************/
void OGLES2OcclusionQueries::LoadVbos()
{
...
******************************************************************************/
void OGLES2OcclusionQueries::LoadOcclusionQueryData()
{
	...
	m_Extensions.glGenQueriesEXT(m_Scene.nNumMesh, m_puiQueryObjects);
...
/*!****************************************************************************
 ...
 @Description	Code in InitApplication() will be called by PVRShell once per
				...
				not be called again.
******************************************************************************/
bool OGLES2OcclusionQueries::InitApplication()
{
	...
	m_eOcclusionQueryMethod = GL_ANY_SAMPLES_PASSED_EXT;
...
/*!****************************************************************************
 ...
 @Description	Code in QuitApplication() will be called by PVRShell once per
				...
				not be called.x
******************************************************************************/
bool OGLES2OcclusionQueries::QuitApplication()
{
...
******************************************************************************/
bool OGLES2OcclusionQueries::InitView()
{
	CPVRTString ErrorStr;
    
    // Check for existance of required extension
    if(!CPVRTgles2Ext::IsGLExtensionSupported("GL_EXT_occlusion_query_boolean"))
	{
		PVRShellSet(prefExitMessage, "Error: Unable to run this example as it requires extension 'GL_EXT_occlusion_query_boolean'");
		return false;
	}

	// Initialise the occlusion query extensions
...
******************************************************************************/
bool OGLES2OcclusionQueries::ReleaseView()
{
	// Delete query objects
	m_Extensions.glDeleteQueriesEXT(1, m_puiQueryObjects);
...
******************************************************************************/
bool OGLES2OcclusionQueries::RenderScene()
{	
	// Handle user input
	...
	if (PVRShellIsKeyPressed(PVRShellKeyNameACTION1))
		m_eOcclusionQueryMethod = (m_eOcclusionQueryMethod == GL_ANY_SAMPLES_PASSED_EXT) ? GL_ANY_SAMPLES_PASSED_CONSERVATIVE_EXT : GL_ANY_SAMPLES_PASSED_EXT;		
	...
	for (unsigned int i=0; i < m_Scene.nNumMesh; i++)
	{
		...
		if (!m_pOcclusionQueryData[i].query_ongoing)
		{
			...
			m_Extensions.glBeginQueryEXT(m_eOcclusionQueryMethod, m_puiQueryObjects[i]); 								
			RenderBoundingBox(iEffectId, m_puiBoundingBoxVbos[i], m_Scene.GetWorldMatrix(m_Scene.pNode[i]), PVRTVec4(1.0f), false);			
			m_Extensions.glEndQueryEXT(m_eOcclusionQueryMethod);
		}				
	}	
...
******************************************************************************/
void OGLES2OcclusionQueries::UpdateOcclusionData()
{	
	...
	for (unsigned int i=0; i < m_Scene.nNumMesh; i++)
	{
		...
		m_Extensions.glGetQueryObjectuivEXT(m_puiQueryObjects[i], GL_QUERY_RESULT_AVAILABLE_EXT, &available);
		...
		if (available == GL_TRUE)
		{
			...
			m_Extensions.glGetQueryObjectuivEXT(m_puiQueryObjects[i], GL_QUERY_RESULT_EXT, &samplesPassed);
			if (samplesPassed > 0)
				m_pOcclusionQueryData[i].visible = true;
			else
...
******************************************************************************/
void OGLES2OcclusionQueries::Update()
{
...
******************************************************************************/
void OGLES2OcclusionQueries::CalculateBoundingBox(const SPODMesh& mesh, PVRTVec3 &minCoord, PVRTVec3 &maxCoord)
{
...
******************************************************************************/
void OGLES2OcclusionQueries::RenderBoundingBox(const unsigned int uiEffectId, const GLuint vbo, const PVRTMat4 mModel, const PVRTVec4 vColour, const bool bWireframe)
{
...
******************************************************************************/
bool OGLES2OcclusionQueries::RenderSceneWithEffect(const int uiEffectId, const PVRTMat4 &mProjection, const PVRTMat4 &mView)
{
...
******************************************************************************/
bool OGLES2OcclusionQueries::LoadPFX(CPVRTString *pErrorMsg)
{
	CPVRTString error = "";
...
PVRShell* NewDemo()
{
	return new OGLES2OcclusionQueries();
}

/******************************************************************************
 End of file (OGLES2OcclusionQueries.cpp)
******************************************************************************/
