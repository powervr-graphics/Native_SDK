...
ASSETDIR := $(PVRSDKDIR)/Examples/Intermediate/MultiSampling/Vulkan/Build/Android/assets
...
# Module VulkanMultiSampling
include $(CLEAR_VARS)

LOCAL_MODULE    := VulkanMultiSampling

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := VulkanMultiSampling.cpp
