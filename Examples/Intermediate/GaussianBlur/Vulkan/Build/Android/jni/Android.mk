...
ASSETDIR := $(PVRSDKDIR)/Examples/Intermediate/GaussianBlur/Vulkan/Build/Android/assets
...
# Module VulkanGaussianBlur
include $(CLEAR_VARS)

LOCAL_MODULE    := VulkanGaussianBlur

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := VulkanGaussianBlur.cpp
