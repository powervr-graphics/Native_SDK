...
ASSETDIR := $(PVRSDKDIR)/Examples/Intermediate/GaussianBlur/OGLES/Build/Android/assets
...
# Module OGLESGaussianBlur
include $(CLEAR_VARS)

LOCAL_MODULE    := OGLESGaussianBlur

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := OGLESGaussianBlur.cpp
