...
ASSETDIR := $(PVRSDKDIR)/Examples/Intermediate/MultiviewVR/OGLES/Build/Android/assets
...
# Module OGLESMultiviewVR
include $(CLEAR_VARS)

LOCAL_MODULE    := OGLESMultiviewVR

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := OGLESMultiviewVR.cpp
