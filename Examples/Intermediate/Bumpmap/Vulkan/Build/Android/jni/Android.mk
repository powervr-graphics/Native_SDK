...
ASSETDIR := $(PVRSDKDIR)/Examples/Intermediate/Bumpmap/Vulkan/Build/Android/assets
...
# Module VulkanBumpmap
include $(CLEAR_VARS)

LOCAL_MODULE    := VulkanBumpmap

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := VulkanBumpmap.cpp
