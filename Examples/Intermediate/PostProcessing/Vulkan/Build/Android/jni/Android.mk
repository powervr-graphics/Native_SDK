...
ASSETDIR := $(PVRSDKDIR)/Examples/Intermediate/PostProcessing/Vulkan/Build/Android/assets
...
# Module VulkanPostProcessing
include $(CLEAR_VARS)

LOCAL_MODULE    := VulkanPostProcessing

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := VulkanPostProcessing.cpp
