...
ASSETDIR := $(PVRSDKDIR)/Examples/Intermediate/PostProcessing/OGLES/Build/Android/assets
...
# Module OGLESPostProcessing
include $(CLEAR_VARS)

LOCAL_MODULE    := OGLESPostProcessing

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := OGLESPostProcessing.cpp
