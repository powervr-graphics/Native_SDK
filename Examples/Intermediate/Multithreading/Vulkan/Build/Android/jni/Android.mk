...
ASSETDIR := $(PVRSDKDIR)/Examples/Intermediate/Multithreading/Vulkan/Build/Android/assets
...
# Module VulkanMultithreading
include $(CLEAR_VARS)

LOCAL_MODULE    := VulkanMultithreading

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := VulkanMultithreading.cpp
