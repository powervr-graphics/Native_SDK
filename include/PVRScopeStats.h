...
****************************************************************************/
PVRSCOPE_EXPORT
enum EPVRScopeInitCode PVRScopeInitialise(struct SPVRScopeImplData **ppsData ///< Context data
);
...
***************************************************************************/
PVRSCOPE_EXPORT
void PVRScopeDeInitialise(struct SPVRScopeImplData            **ppsData,     ///< Context data
...
****************************************************************************/
PVRSCOPE_EXPORT
void PVRScopeGetInfo(struct SPVRScopeImplData *const psData, ///< Context data
...
****************************************************************************/
PVRSCOPE_EXPORT
int PVRScopeGetCounters(struct SPVRScopeImplData *const       psData,      ///< Context data
...
PVRSCOPE_EXPORT
unsigned int
PVRScopeFindStandardCounter(const unsigned int                      nCount,     ///< Returned number of counters, from PVRScopeGetCounters
...
****************************************************************************/
PVRSCOPE_EXPORT
int PVRScopeReadCounters(struct SPVRScopeImplData *const       psData,   ///< Context data
...
****************************************************************************/
PVRSCOPE_EXPORT
void PVRScopeSetGroup(struct SPVRScopeImplData *const psData, ///< Context data
...
****************************************************************************/
PVRSCOPE_EXPORT
const struct SPVRScopeTimingPacket *PVRScopeReadTimingData(struct SPVRScopeImplData *const psData, ///< Context data
