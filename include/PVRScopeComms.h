...
enum ESPSCommsLibType
{
    ...
    eSPSCommsLibTypeEnum, ///< data is string (NOT NULL-terminated, use length parameter). First line is selection number, subsequent lines
...
****************************************************************************/
PVRSCOPE_EXPORT
struct SSPSCommsData *pplInitialise(const char *const  psName,  ///< String to describe the application
...
****************************************************************************/
PVRSCOPE_EXPORT
void pplShutdown(struct SSPSCommsData *psData ///< Context data
);
...
****************************************************************************/
PVRSCOPE_EXPORT
void pplWaitForConnection(struct SSPSCommsData **const ppsData,       ///< Array of context data pointers
...
****************************************************************************/
PVRSCOPE_EXPORT
unsigned int pplGetTimeUS(struct SSPSCommsData *const psData ///< Context data
);
...
****************************************************************************/
PVRSCOPE_EXPORT
int pplSendMark(struct SSPSCommsData *const psData,   ///< Context data
...
****************************************************************************/
PVRSCOPE_EXPORT
int pplSendProcessingBegin(struct SSPSCommsData *const psData,   ///< Context data
...
****************************************************************************/
PVRSCOPE_EXPORT
int pplSendProcessingEnd(struct SSPSCommsData *const psData ///< Context data
);
...
****************************************************************************/
PVRSCOPE_EXPORT
int pplLibraryCreate(struct SSPSCommsData *const              psData,    ///< Context data
...
****************************************************************************/
PVRSCOPE_EXPORT
int pplLibraryDirtyGetFirst(struct SSPSCommsData *const psData,       ///< Context data
...
****************************************************************************/
PVRSCOPE_EXPORT
int pplCountersCreate(struct SSPSCommsData *const             psData,        ///< Context data
...
****************************************************************************/
PVRSCOPE_EXPORT
int pplCountersUpdate(struct SSPSCommsData *const psData,           ///< Context data
...
****************************************************************************/
PVRSCOPE_EXPORT
int pplSendFlush(struct SSPSCommsData *const psData ///< Context data
);
...
public:
    CPPLProcessingScoped(SSPSCommsData *const psData,    ///< Context data
                         const char *const    psString,  ///< Name of the processing block
                         const unsigned int   nLen,      ///< String length
