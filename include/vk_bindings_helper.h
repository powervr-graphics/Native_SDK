...
static inline void initVkDeviceBindings(VkDevice device, VkDeviceBindings *bindings, PFN_vkGetDeviceProcAddr getDeviceProcAddress) {
	...
	bindings->vkGetPipelineExecutablePropertiesKHR = (PFN_vkGetPipelineExecutablePropertiesKHR) getDeviceProcAddress(device, "vkGetPipelineExecutablePropertiesKHR");
	bindings->vkGetPipelineExecutableStatisticsKHR = (PFN_vkGetPipelineExecutableStatisticsKHR) getDeviceProcAddress(device, "vkGetPipelineExecutableStatisticsKHR");
	bindings->vkGetPipelineExecutableInternalRepresentationsKHR = (PFN_vkGetPipelineExecutableInternalRepresentationsKHR) getDeviceProcAddress(device, "vkGetPipelineExecutableInternalRepresentationsKHR");
	...
	bindings->vkGetImageViewHandleNVX = (PFN_vkGetImageViewHandleNVX) getDeviceProcAddress(device, "vkGetImageViewHandleNVX");
	...
	bindings->vkInitializePerformanceApiINTEL = (PFN_vkInitializePerformanceApiINTEL) getDeviceProcAddress(device, "vkInitializePerformanceApiINTEL");
	bindings->vkUninitializePerformanceApiINTEL = (PFN_vkUninitializePerformanceApiINTEL) getDeviceProcAddress(device, "vkUninitializePerformanceApiINTEL");
	bindings->vkCmdSetPerformanceMarkerINTEL = (PFN_vkCmdSetPerformanceMarkerINTEL) getDeviceProcAddress(device, "vkCmdSetPerformanceMarkerINTEL");
	bindings->vkCmdSetPerformanceStreamMarkerINTEL = (PFN_vkCmdSetPerformanceStreamMarkerINTEL) getDeviceProcAddress(device, "vkCmdSetPerformanceStreamMarkerINTEL");
	bindings->vkCmdSetPerformanceOverrideINTEL = (PFN_vkCmdSetPerformanceOverrideINTEL) getDeviceProcAddress(device, "vkCmdSetPerformanceOverrideINTEL");
	bindings->vkAcquirePerformanceConfigurationINTEL = (PFN_vkAcquirePerformanceConfigurationINTEL) getDeviceProcAddress(device, "vkAcquirePerformanceConfigurationINTEL");
	bindings->vkReleasePerformanceConfigurationINTEL = (PFN_vkReleasePerformanceConfigurationINTEL) getDeviceProcAddress(device, "vkReleasePerformanceConfigurationINTEL");
	bindings->vkQueueSetPerformanceConfigurationINTEL = (PFN_vkQueueSetPerformanceConfigurationINTEL) getDeviceProcAddress(device, "vkQueueSetPerformanceConfigurationINTEL");
	bindings->vkGetPerformanceParameterINTEL = (PFN_vkGetPerformanceParameterINTEL) getDeviceProcAddress(device, "vkGetPerformanceParameterINTEL");
	bindings->vkSetLocalDimmingAMD = (PFN_vkSetLocalDimmingAMD) getDeviceProcAddress(device, "vkSetLocalDimmingAMD");
...
#ifdef VK_USE_PLATFORM_WIN32_KHR
	bindings->vkAcquireFullScreenExclusiveModeEXT = (PFN_vkAcquireFullScreenExclusiveModeEXT) getDeviceProcAddress(device, "vkAcquireFullScreenExclusiveModeEXT");
#endif // VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
	bindings->vkReleaseFullScreenExclusiveModeEXT = (PFN_vkReleaseFullScreenExclusiveModeEXT) getDeviceProcAddress(device, "vkReleaseFullScreenExclusiveModeEXT");
#endif // VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
	bindings->vkGetDeviceGroupSurfacePresentModes2EXT = (PFN_vkGetDeviceGroupSurfacePresentModes2EXT) getDeviceProcAddress(device, "vkGetDeviceGroupSurfacePresentModes2EXT");
#endif // VK_USE_PLATFORM_WIN32_KHR
	bindings->vkCmdSetLineStippleEXT = (PFN_vkCmdSetLineStippleEXT) getDeviceProcAddress(device, "vkCmdSetLineStippleEXT");
	bindings->vkResetQueryPoolEXT = (PFN_vkResetQueryPoolEXT) getDeviceProcAddress(device, "vkResetQueryPoolEXT");
}
...
static inline void initVkInstanceBindings(VkInstance instance, VkInstanceBindings *bindings, PFN_vkGetInstanceProcAddr getinstanceProcAddress) {
	...
	bindings->vkCreateStreamDescriptorSurfaceGGP = (PFN_vkCreateStreamDescriptorSurfaceGGP) getinstanceProcAddress(instance, "vkCreateStreamDescriptorSurfaceGGP");
	...
	bindings->vkCreateMetalSurfaceEXT = (PFN_vkCreateMetalSurfaceEXT) getinstanceProcAddress(instance, "vkCreateMetalSurfaceEXT");
#endif // VK_USE_PLATFORM_METAL_EXT
	bindings->vkGetPhysicalDeviceCooperativeMatrixPropertiesNV = (PFN_vkGetPhysicalDeviceCooperativeMatrixPropertiesNV) getinstanceProcAddress(instance, "vkGetPhysicalDeviceCooperativeMatrixPropertiesNV");
	bindings->vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV = (PFN_vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV) getinstanceProcAddress(instance, "vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV");
#ifdef VK_USE_PLATFORM_WIN32_KHR
	bindings->vkGetPhysicalDeviceSurfacePresentModes2EXT = (PFN_vkGetPhysicalDeviceSurfacePresentModes2EXT) getinstanceProcAddress(instance, "vkGetPhysicalDeviceSurfacePresentModes2EXT");
#endif // VK_USE_PLATFORM_WIN32_KHR
	bindings->vkCreateHeadlessSurfaceEXT = (PFN_vkCreateHeadlessSurfaceEXT) getinstanceProcAddress(instance, "vkCreateHeadlessSurfaceEXT");
}
